<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechGradeDict.aspx.cs" Inherits="GoldNet.JXKP.RLZY.DICT.TechGradeDict" %>
                                            ...
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column Header="等级名称" Width="150" Align="Center" Sortable="false" MenuDisabled="true"
