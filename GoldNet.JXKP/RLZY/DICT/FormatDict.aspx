<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormatDict.aspx.cs" Inherits="GoldNet.JXKP.RLZY.DICT.FormatDict" %>
                                            ...
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column Header="开本" Width="150" Align="Center" Sortable="false" MenuDisabled="true"
