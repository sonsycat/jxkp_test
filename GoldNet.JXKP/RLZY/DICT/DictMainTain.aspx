<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictMainTain.aspx.cs" Inherits="GoldNet.JXKP.RLZY.DICT.DictMainTain" %>
                    ...
                    <North>
                        <ext:Toolbar runat="server" ID="ctl155" StyleSpec="border:0">
                            <Items>
                                ...
                                <ext:Button Text="修改报表" ID="btn_Modify" runat="server" Icon="FolderEdit" Disabled="true">
                                    <Listeners>
                                        <Click Handler="TreeOpration(2)" />
                                    </Listeners>
                                </ext:Button>
                                <ext:Button Text="删除报表" ID="btn_Delete" runat="server" Icon="Delete" Disabled="true">
                                    <Listeners>
                                            ...
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column Header="" Width="150" Align="Center" Sortable="false" MenuDisabled="true"
