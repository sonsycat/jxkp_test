...
{
    public partial class PublicationGradeDict : System.Web.UI.Page
    {
        private static string TableName = "PUBLICATION_GRADE_DICT";
        private static string fieldId = "ID";
        private static string fieldName = "PUBLICATION_GRADE";
