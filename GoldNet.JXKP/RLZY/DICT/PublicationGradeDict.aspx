<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicationGradeDict.aspx.cs" Inherits="GoldNet.JXKP.RLZY.DICT.PublicationGradeDict" %>
                                            ...
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column Header="刊物等级" Width="150" Align="Center" Sortable="false" MenuDisabled="true"
