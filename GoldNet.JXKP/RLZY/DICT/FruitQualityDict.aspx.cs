...
{
    public partial class FruitQualityDict : System.Web.UI.Page
    {
        private static string TableName = "FRUIT_QUALITY_DICT";
        private static string fieldId = "ID";
        private static string fieldName = "FRUIT_QUALITY";
