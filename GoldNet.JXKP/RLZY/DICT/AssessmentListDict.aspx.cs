...
{
    public partial class AssessmentListDict : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                this.Store1.DataSource = dal.ViewAssessmentListDict().Tables[0];
        ...
        {
            Store1.RemoveAll();
            Store1.DataSource = dal.ViewAssessmentListDict().Tables[0];
            Store1.DataBind();
        }
        ...
        public void DictAjaxOper(string DictCode, string DictName, string OperType, string PersonType)
        {
            ...
            {
                case "1":
                    dal.InsertAssessmentListDict(DictName, PersonType);
                    break;
                case "2":
                    dal.UpdataAssessmentListDict(DictCode, DictName, PersonType);
                    break;
                case "3":
                    dal.DelAssessmentListDict(DictCode);
                    break;
            }
        }
    }
