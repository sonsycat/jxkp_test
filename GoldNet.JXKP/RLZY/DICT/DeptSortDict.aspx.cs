...
{
    public partial class DeptSortDict : System.Web.UI.Page
    {
        private static string TableName = "DEPT_SORT_DICT";
        private static string fieldId = "SEID";
        private static string fieldName = "SORT_NAME";
