<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecCenterDict.aspx.cs"
    Inherits="GoldNet.JXKP.RLZY.DICT.SpecCenterDict" %>
    ...
    <script type="text/javascript">
       ...
       function TreeOpration(optype) {
            if (optype == "1") {
                ...
                txtCode.setValue(this.Store1.getAt(RowIndex).get('CENTER_CODE'));
                txtName.setValue(this.Store1.getAt(RowIndex).get('CENTER_NAME'));
                Btn_BatStart.setText("修改");
                arcEditWindow.show();
            } else if (optype == "3") {
                Btn_BatStart.setText("");
                Ext.Msg.confirm("删除项目", "确定要删除该项目：" + this.Store1.getAt(RowIndex).get('CENTER_NAME') + " 吗？", function(btn, text) { OpCallback(btn) });
            } 
        }
        ...
        */
        function OpCallback (btn) {
            ...
            if (optype == "1") {
               ...
               GridPanelToDataBase(this.Store1.getAt(RowIndex).get('ID'), code,name,optype);
            } else if (optype == "3") {
...
<body>
    ...
    <div>
                                        ...
                                        <ext:LayoutColumn ColumnWidth="1">
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        <ext:Column Header="专科中心代码" Width="90" Align="Left" Sortable="false" MenuDisabled="true"
                                                            ColumnID="ID" DataIndex="CENTER_CODE" />
                                                        <ext:Column Header="专科中心名称" Width="150" Align="Center" Sortable="false" MenuDisabled="true"
                                                            ColumnID="NAME" DataIndex="CENTER_NAME" />
                                                    </Columns>
                                                </ColumnModel>
                                                <SelectionModel>
        ...
        <ext:Window ID="arcEditWindow" runat="server" Icon="Group" Title="设置专科中心字典" Width="300"
            Height="150" AutoShow="false" Modal="true" CenterOnLoad="true" ShowOnLoad="false"
                            ...
                            <Body>
                                <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left">
                                    <ext:Anchor Horizontal="92%">
                                        <ext:TextField ID="txtCode" runat="server" FieldLabel="专科中心代码" />
                                    </ext:Anchor>
                                    <ext:Anchor Horizontal="92%">
                                        <ext:TextField ID="txtName" runat="server" FieldLabel="专科中心名称" />
                                    </ext:Anchor>
                                </ext:FormLayout>
                            </Body>
                        </ext:Panel>
