...
{
    public partial class PersonsPlantDict : System.Web.UI.Page
    {
        private static string TableName = "PERSONS_PLANT_DICT";
        private static string fieldId = "ID";
        private static string fieldName = "PERSONS_PLANT";
