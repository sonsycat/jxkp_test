...
{
    public partial class ExamScoreListDict : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                this.Store1.DataSource = dal.ViewExamScoreListDict().Tables[0];
        ...
        {
            Store1.RemoveAll();
            Store1.DataSource = dal.ViewExamScoreListDict().Tables[0];
            Store1.DataBind();
        }
        ...
        public void DictAjaxOper(string DictCode, string DictName, string OperType, string PersonType)
        {
            ...
            {
                case "1":
                    dal.InsertExamScoreListDict(DictName, PersonType);
                    break;
                case "2":
                    dal.UpdataExamScoreListDict(DictCode, DictName, PersonType);
                    break;
                case "3":
                    dal.DelExamScoreListDict(DictCode);
                    break;
            }
        }
    }
