<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffStaf.aspx.cs" Inherits="GoldNet.JXKP.RLZY.BaseInfoMaintain.StaffStaf" %>
                    ...
                    <North>
                        <ext:Toolbar runat="server" ID="ctl155" StyleSpec="border:0">
                            <Items>
                                ...
                                <ext:ComboBox ID="cboPersonType" runat="server" Editable="false"></ext:ComboBox>
                                            ...
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column ColumnID="DUTYDATE" Header="职务时间" Sortable="true" DataIndex="DUTYDATE" />
                                                    </Columns>
                                                </ColumnModel>
                                                <SelectionModel>
