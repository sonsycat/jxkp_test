<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffWorkday_ZWJT_report.aspx.cs"
    Inherits="GoldNet.JXKP.RLZY.BaseInfoMaintain.StaffWorkday_ZWJT_report" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="ZGTS">
                    </ext:RecordField>
                    <ext:RecordField Name="ZWBZ">
                    </ext:RecordField>
                    <ext:RecordField Name="ZWJT">
                    </ext:RecordField>
                </Fields>
            </ext:JsonReader>
        </Reader>
                            ...
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        ...
                                        <ext:ExtColumn ColumnID="ZGTS" Header="<div style='text-align:center;'>在岗天数</div>"
                                            Width="120" DataIndex="ZGTS" MenuDisabled="true" Align="Right">
                                        ...
                                        <ext:ExtColumn ColumnID="ZWJT" Header="<div style='text-align:center;'>职务津贴</div>"
                                            Width="120" DataIndex="ZWJT" MenuDisabled="true" Align="Right">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:ExtColumn>
                                    </Columns>
                                </ColumnModel>
