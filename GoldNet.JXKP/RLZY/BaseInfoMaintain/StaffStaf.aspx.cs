...
{
    public partial class StaffStaf : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                this.Store1.DataSource = dal.ViewStaffBaseInfo("", sort.TrimEnd(new char[]{','}), this.DeptFilter(""), "1").Tables[0];
        ...
        protected void QueryStaff(object sender, AjaxEventArgs e)
        {
            ...
            DataTable l_dt1 = dal.ViewStaffBaseInfo(this.DeptCodeCombo.SelectedItem.Value.ToString(), sort.TrimEnd(new char[] { ',' }), this.DeptFilter(""), "1").Tables[0];
