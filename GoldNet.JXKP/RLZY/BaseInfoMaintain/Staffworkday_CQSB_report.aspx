<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Staffworkday_CQSB_report.aspx.cs" Inherits="GoldNet.JXKP.RLZY.Staffworkday_CQSB_report" %>
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        <ext:ExtColumn ColumnID="DEPT_NAME" Header="<div style='text-align:center;'>科室</div>"
                                            Width="160" DataIndex="DEPT_NAME" MenuDisabled="true">
                                        </ext:ExtColumn>
                                        <ext:ExtColumn ColumnID="RS" Header="<div style='text-align:center;'>已审核</div>"
                                            Width="120" DataIndex="RS" MenuDisabled="true">
                                        </ext:ExtColumn>
                                        <ext:ExtColumn ColumnID="RS2" Header="<div style='text-align:center;'>未审核</div>"
                                            Width="120" DataIndex="RS2" MenuDisabled="true">
                                        </ext:ExtColumn>
                                    </Columns>
                                </ColumnModel>
                                <SelectionModel>
