<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Staffworkday_KQ_report.aspx.cs"
    Inherits="GoldNet.JXKP.RLZY.BaseInfoMaintain.Staffworkday_KQ_report" %>
                            ...
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0">
                                        <Items>
                                            <ext:Label ID="Label3" runat="server" Text="时间：" />
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        <ext:ExtColumn ColumnID="DEPT_NAME" Header="<div style='text-align:center;'>科室</div>"
                                            Width="180" DataIndex="DEPT_NAME" MenuDisabled="true">
                                        </ext:ExtColumn>
                                        <ext:ExtColumn ColumnID="RS" Header="<div style='text-align:center;'>空勤人数</div>" Width="120"
                                            DataIndex="RS" MenuDisabled="true">
                                        </ext:ExtColumn>
                                    </Columns>
                                </ColumnModel>
                                <SelectionModel>
