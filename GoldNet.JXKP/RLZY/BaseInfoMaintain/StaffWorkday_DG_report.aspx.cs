...
{
    public partial class StaffWorkday_DG_report : PageBase
    {
        /// <summary>
        /// 初始化处理
        /// </summary>
        ...
        private void data(string stdate)
        {
            ...
            DataTable dt = tdal.SearchDG(stdate, deptcode).Tables[0];
            if (dt != null)
            {
                ...
                Store1.DataBind();
                Session.Remove("staffworkdayDG");
                Session["staffworkdayDG"] = dt;
            }
            else
            {
