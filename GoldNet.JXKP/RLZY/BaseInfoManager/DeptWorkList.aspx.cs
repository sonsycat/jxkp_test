...
{
    public partial class DeptWorkList : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                SetCombox();
                this.Store1.DataSource = dal.ViewDeptWorkList(DateTime.Now.Year.ToString() + "-01-01", DateTime.Now.ToString("yyyy-MM-dd"), "", this.DeptFilter(""));
        ...
        public void Data_RefreshData(object sender, StoreRefreshDataEventArgs e)
        {
            ...
            this.Store1.DataSource = dal.ViewDeptWorkList(dd1, dd2, this.DeptCodeCombo.SelectedItem.Value, this.DeptFilter(""));
            this.Store1.DataBind();
        }
        ...
        protected void SaveInfo(object sender, AjaxEventArgs e)
        {
            ...
            dal.InsertDeptWorkList(DateTime.Now.ToString("yyyy-MM-dd"), this.DeptCodeCombo.SelectedItem.Value, this.DeptCodeCombo.SelectedItem.Text, Creater, this.txaWorkDetail.Text);
        ...
        {
            dal.UpdateDeptWorkList(this.txaWorkDetail.Text, HiddenId.Text);
            Goldnet.Ext.Web.ScriptManager scManager = Goldnet.Ext.Web.ScriptManager.GetInstance(this.Page);
            scManager.AddScript("Store1.reload();");
            scManager.AddScript("btn_Modify.setDisabled(true);");
            scManager.AddScript("btn_Delete.setDisabled(true);");
        ...
        [AjaxMethod]
        public void DeptWorkListAjaxOper(string Id)
        {
            dal.DeleteDeptWorkList(Id);
        }
