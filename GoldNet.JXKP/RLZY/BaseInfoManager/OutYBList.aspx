<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutYBList.aspx.cs" Inherits="GoldNet.JXKP.RLZY.BaseInfoManager.OutYBList" %>
...
<body>
    ...
    <ext:Window ID="arcEditWindow" runat="server" Icon="Group" Title="医保外联总结" Width="600"
                        ...
                        <Body>
                            <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left">
                                <ext:Anchor Horizontal="95%">
                                    <ext:TextArea ID="txaWorkDetail" runat="server" FieldLabel="医保外联总结" Height="300">
                                    </ext:TextArea>
                                </ext:Anchor>
                            </ext:FormLayout>
                        </Body>
