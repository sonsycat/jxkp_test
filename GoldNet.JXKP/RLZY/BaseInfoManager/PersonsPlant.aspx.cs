...
{
    public partial class PersonsPlant : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                SetCombox();
                this.Store1.DataSource = dal.ViewPersonsPlant(DateTime.Now.Year.ToString() + "-01-01", DateTime.Now.ToString("yyyy-MM-dd"), "", this.DeptFilter(""));
        ...
        private void SetCombox()
        {
            ...
            //获奖类别等级字典
            cboDt = dictdal.getDictInfo("PERSONS_PLANT_DICT", "ID", "PERSONS_PLANT", true, "IS_DEL").Tables[0];
            SetCboData("ID", "PERSONS_PLANT", cboDt, cboSort);
        ...
        public void Data_RefreshData(object sender, StoreRefreshDataEventArgs e)
        {
            ...
            this.Store1.DataSource = dal.ViewPersonsPlant(dd1, dd2, this.DeptCodeCombo.SelectedItem.Value, this.DeptFilter(""));
            this.Store1.DataBind();
        }
        ...
        {
            dal.InsertPersonsPlant(this.DeptCodeCombo.SelectedItem.Value, this.cboSort.SelectedItem.Text, this.cboStaffInfo.SelectedItem.Text, this.txtUnit.Text,
                                    this.dtfStartDate.SelectedDate.ToString("yyyy-MM-dd"), this.dtfEndDate.SelectedDate.ToString("yyyy-MM-dd"), this.txtTerm.Text,
                                    this.txrContent.Text, this.txtDeptSpecial.Text, this.cboStaffInfo.SelectedItem.Value, this.txtLightspotName.Text, this.txtFinishingSituation.Text,
                                    this.txrCheckResult.Text);
        ...
        protected void EditInfo(object sender, AjaxEventArgs e)
        {
            ...
            //                    this.txtScienceMeetingPlace.Text, "", this.txrContent.Text, "0");

            string deptcode = e.ExtraParams["deptCode"].ToString();
            string deptName = e.ExtraParams["deptName"].ToString();
            dal.UpdatePersonsPlant(HiddenId.Text, deptcode, deptName, this.cboStaffInfo.SelectedItem.Text, this.txtUnit.Text,
                                    this.dtfStartDate.SelectedDate.ToString("yyyy-MM-dd"), this.dtfEndDate.SelectedDate.ToString("yyyy-MM-dd"), this.txtTerm.Text,
                                    this.txrContent.Text, this.txtDeptSpecial.Text, this.cboStaffInfo.SelectedItem.Value, this.txtLightspotName.Text, this.txtFinishingSituation.Text,
                                    this.txrCheckResult.Text);
            Goldnet.Ext.Web.ScriptManager scManager = Goldnet.Ext.Web.ScriptManager.GetInstance(this.Page);
        ...
        [AjaxMethod]
        public void PersonsPlantAjaxOper(string Id)
        {
            dal.DelPersonsPlant(Id);
        }
