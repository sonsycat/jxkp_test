...
{
    public partial class OnGuardDaysDept : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                //科室类别
                this.cbbdept.Items.Add(new Goldnet.Ext.Web.ListItem("核算科室", "核算科室"));
                this.cbbdept.Items.Add(new Goldnet.Ext.Web.ListItem("平均奖科室", "平均奖科室"));


                //int year = Convert.ToInt32(DateTime.Now.AddMonths(-1).Year.ToString());
                //int month = Convert.ToInt32(DateTime.Now.AddMonths(-1).Month.ToString());
                //string deptcode = "";
                data(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(year), Convert.ToInt32(month), "平均奖科室");
            }
        }
        ...
        public void data(int year, int month, int endyear, int endmonth, string deptcode)
        {
            ...
            DataTable table = dal.ViewOnGuardDays3(datetime, enddatetime, sort.TrimEnd(new char[] { ',' }), days, this.DeptFilter(""), "", deptcode).Tables[0];
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            DataTable dt = dal.ViewOnGuardDays3(datetime, enddatetime, sort.TrimEnd(new char[] { ',' }), days, this.DeptFilter(""), "", deptcode).Tables[0];
