...
{
    public partial class Sys_Menu_List_new : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Store1.DataSource = dal_appor.GetSysMenulistByGroup("");
                Store1.DataBind();
            }
        }
        ...
        protected void Btn_Edit_Click(object sender, AjaxEventArgs e)
        {
            ...
            if (selectRow != null)
            {
                ...
                loadcfg.Params.Add(new Goldnet.Ext.Web.Parameter("MenuClass", "1"));
