<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_Menu_Attr.aspx.cs" Inherits="GoldNet.JXKP.WebPage.SysManager.Sys_Menu_Attr" %>
...
<body>
    ...
    <div>
        ...
        <ext:Store ID="Store1" runat="server" OnRefreshData="Store_RefreshData">
            <Reader>
                <ext:JsonReader ReaderID="ATTR_ID">
                    <Fields>
                        <ext:RecordField Name="ATTR_ID" Type="String" Mapping="ATTR_ID" />
                        <ext:RecordField Name="ATTR_NAME" Type="String" Mapping="ATTR_NAME" />
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                    <ext:Column ColumnID="ATTR_ID" Header="<div style='text-align:center;'>编号</div>"
                                            Width="100" Align="Center" Sortable="false" DataIndex="ATTR_ID" MenuDisabled="true"/>
                                        <ext:Column ColumnID="ATTR_NAME" Header="<div style='text-align:center;'>属性名称</div>"
