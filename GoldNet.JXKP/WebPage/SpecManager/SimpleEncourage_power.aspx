<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SimpleEncourage_power.aspx.cs" Inherits="GoldNet.JXKP.WebPage.SpecManager.SimpleEncourage_power" %>
                        ...
                        <ext:ColumnLayout ID="ColumnLayout1" runat="server" FitHeight="true">
                            ...
                            <ext:LayoutColumn ColumnWidth="0.5">
                                ...
                                <ext:Toolbar ID="Toolbar2" runat="server">
                                    <Items>
                                        <ext:Label ID="role" runat="server" Text="奖励项目：">
                                        </ext:Label>
                                        <ext:ComboBox ID="ComboBox_Pertype" runat="server" AllowBlank="false" EmptyText="请选择奖励项目"
                                            FieldLabel="奖励项目选择" Width="120">
                                            <AjaxEvents>
