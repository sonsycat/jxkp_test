<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Guide_Selector.aspx.cs" Inherits="GoldNet.JXKP.jxkh.Guide_Selector" %>
                 ...
                 <ext:Panel ID="Panel5" runat="server" Border="false"  MonitorResize="true" >
                        <Body>  
                            <ext:MultiSelect ID="SelectorLeft" runat="server"  Legend="待选指标" DragGroup="grp1" DropGroup="grp2,grp1" 
                                StoreID="Store1"
                                DisplayField="GUIDE_NAME"
                                ValueField="GUIDE_CODE"
                        ...
                        <ext:AnchorLayout ID="AnchorLayout1" runat="server">
                            ...
                            <ext:Anchor>
                                <ext:Panel ID="Panel4" runat="server" Border="false" BodyStyle="padding:5px;background-color: transparent;">
                                    <Body>
                                        <ext:Label Text="权重" runat="server" Width="25" StyleSpec="font-size:12px;color:red" ></ext:Label>
                                        <ext:NumberField ID="QZNum" runat="server"   Text="1"  DecimalPrecision="2" Width="25" MaxLength="4"  StyleSpec="margin-bottom:10px;">
