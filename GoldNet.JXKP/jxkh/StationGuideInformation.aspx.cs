...
{
    public partial class StationGuideInformation : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                guidegathercode = Request.QueryString["gd"].ToString();
                ...
                DataTable dt = dal.GetStationGuideTarget(stationcode, stationyear, guidegathercode).Tables[0];
                DataRow[] Rows;
                DataTable dtt;
        ...
        protected void BtnSave_Click(object sender, AjaxEventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    dal.SaveStationGuideTarget(stationcode, stationyear, guidegathercode, selectRows);
                    Goldnet.Ext.Web.ScriptManager scManager = Goldnet.Ext.Web.ScriptManager.GetInstance(this.Page);
                    scManager.AddScript("parent.RefreshData2();");
                    Ext.Msg.Alert("系统提示", "岗位指标量化保存成功!").Show();
                }
                catch (Exception ee)
                {
        ...
        protected void Buttonset_Click(object sender, EventArgs e)
        {
            ...
            loadcfg.Params.Add(new Goldnet.Ext.Web.Parameter("stationcode", stationcode));
