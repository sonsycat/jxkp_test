<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Guide_Group_Role.aspx.cs"
    Inherits="GoldNet.JXKP.jxkh.Guide_Group_Role" %>
                            ...
                            <TopBar>
                                <ext:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        ...
                                        <ext:TextField ID="GuideGatherCode" runat="server" Hidden="true"/>
                        ...
                        <ext:ColumnLayout ID="ColumnLayout1" runat="server" FitHeight="true">
                            ...
                            <ext:LayoutColumn ColumnWidth="0.5">
                                ...
                                <ext:Toolbar ID="Toolbar2" runat="server">
                                    <Items>
                                        <ext:Label ID="role" runat="server" Text="指标集：">
                                        </ext:Label>
                                        <ext:ComboBox ID="ComboBox_Group" runat="server" AllowBlank="false" EmptyText="请选择指标集"
                                            FieldLabel="指标集选择" Width="120">
                                            <AjaxEvents>
                                                <Select OnEvent="SelectedGroup">
