...
{
    public partial class SetReportType : System.Web.UI.Page
    {
        ...
        private void TreeInitBuild()
        {
            ...
            DataTable dt = dal.getReportTypeTreeBuilder().Tables[0];
        ...
        public string DelTreeNode(string nodeid)
        {
            ...
            if (dal.EstimateData(nodeid, "REPORT_LIST_DICT"))
            {
                dal.DelReportTypeCenterDict(nodeid, "REPORT_CLASS_DICT");
            }
            else
            {
        ...
        public string UpdateTree(string treeNodesJSON)
        {
            ...
            ReportDalDict dal = new ReportDalDict();
            dal.UpdateReportTypeCenterDict(treeNodes, "REPORT_CLASS_DICT");
            return "";
        }
    }
}
