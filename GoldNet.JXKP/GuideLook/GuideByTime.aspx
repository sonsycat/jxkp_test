<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuideByTime.aspx.cs" Inherits="GoldNet.JXKP.GuideLook.GuideByTime" %>
    ...
    <script type="text/javascript">
       ...
       var refreshGrid = function(node) {
        ...
        function ChartRefresh() {
            if(cbx_OrgType.getSelectedItem().value == '02') {
              refreshDeptChartsConfig();
            }
            if(cbx_OrgType.getSelectedItem().value == '03') {
              refreshChartsConfig();
            }
        } 
                        ...
                        <ext:Panel runat="server" ID="panel3" BodyBorder="false">
                            ...
                            <Body>
                                <ext:Panel ID="GridPanel" runat="server" Border="false" Height="600" AutoScroll="true">
                                    <AutoLoad Url="GuideByTimeChart.aspx" Mode="IFrame">
                                    </AutoLoad>
                                </ext:Panel>
                            </Body>
                            <BottomBar>
                                <ext:Toolbar ID="Toolbar2123123" runat="server" Height="26">
                                    <Items>
                                     <ext:Label ID="func" runat="server" Text="绩效年度：" Width="40" />
                                        <ext:ComboBox runat="server" ID="cbx_Years" Width="80">
                                        </ext:ComboBox>
                                        <ext:ComboBox runat="server" ID="cboFromMonth" Width="60">
                                        </ext:ComboBox>
                                        <ext:Label ID="Label2" runat="server" Text="　至　" Width="40" />
                                        <ext:ComboBox runat="server" ID="cboToMonth" Width="60">
                                        </ext:ComboBox>
                                        ...
                                        <ext:Button ID="btnSreach" runat="server" Text=" 查询 " Icon="DatabaseGo">
                                        <Listeners>
                ...
                <ext:TreePanel runat="server" ID="DeptTreePanel" BodyBorder="false" Width="250" Height="350"
                        ...
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <ext:ToolbarButton ID="btnDeptQuery" runat="server" Icon="ServerEdit">
                                    <ToolTips>
                                        <ext:ToolTip ID="ToolTip9" IDMode="Ignore" runat="server" Html="过滤岗位" />
                                    </ToolTips>
                                    <Listeners>
                    ...
                    <BottomBar>
                        <ext:Toolbar ID="Toolbar5" runat="server">
                            <Items>
                                <ext:ToolbarFill ID="ToolbarFill12312411" runat="server" />
            ...
            <Body>
                <ext:Accordion ID="AccordionLayout1" runat="server">
                    <ext:TreePanel ID="TreePanel1" runat="server" Title="按岗位过滤" RootVisible="false" AutoScroll="true"
                        ...
                        <TopBar>
                            <ext:Toolbar ID="Toolbar1231" runat="server">
                                <Items>
