<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerformDeptIncome.aspx.cs"
    Inherits="GoldNet.JXKP.GuideLook.Statement.PerformDeptIncome" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="COSTS" SortType="AsFloat" />
                    <ext:RecordField Name="COSTSMZ" SortType="AsFloat" />
                    <ext:RecordField Name="CHARGESMZ" SortType="AsFloat" />
                    <ext:RecordField Name="COUNT_INCOMEMZ" SortType="AsFloat" />
                    <ext:RecordField Name="COSTSZY" SortType="AsFloat" />
                    <ext:RecordField Name="CHARGESZY" SortType="AsFloat" />
                    <ext:RecordField Name="COUNT_INCOMEZY" SortType="AsFloat" />
                </Fields>
            </ext:JsonReader>
        </Reader>
    </ext:Store>
                                ...
                                <Body>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Width="800"
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:ExtColumn ColumnID="CLASS_NAME" Header="核算科目" Sortable="true" DataIndex="CLASS_NAME" />
                                                <ext:ExtColumn ColumnID="CLASS_CODE" Header="本科" Sortable="true" DataIndex="CLASS_CODE"
                                                    Hidden="true" />
                                                <ext:ExtColumn ColumnID="COSTS" Header="总收入" Sortable="true" DataIndex="COSTS">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="COUNT_INCOMEMZ" Header="军免" Sortable="true" DataIndex="COUNT_INCOMEMZ">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="CHARGESMZ" Header="地方" Sortable="true" DataIndex="CHARGESMZ">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="COSTSMZ" Header="小计" Sortable="true" DataIndex="COSTSMZ">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="COUNT_INCOMEZY" Header="军免" Sortable="true" DataIndex="COUNT_INCOMEZY">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="CHARGESZY" Header="地方" Sortable="true" DataIndex="CHARGESZY">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="COSTSZY" Header="小计" Sortable="true" DataIndex="COSTSZY">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                            </Columns>
                                            <HeadRows>
                                        ...
                                        <AjaxEvents>
                                            <DblClick OnEvent="QueryPerformDeptIncomeInfo">
                                                <ExtraParams>
