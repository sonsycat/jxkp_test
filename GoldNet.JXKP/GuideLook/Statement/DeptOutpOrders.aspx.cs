...
{
    public partial class DeptOutpOrders : PageBase
    {
        ...
        private void setTimeContrl()
        {
            ...
            DataTable dt = dal.getReckItemClass().Tables[0];

            SetCboData(dt, this.cboType);
        ...
        private void SetCboData(DataTable dtSource, ComboBox cbo)
        {
            ...
            {
                cbo.Items.Add(new Goldnet.Ext.Web.ListItem(dtSource.Rows[idx]["CLASS_NAME"].ToString(), dtSource.Rows[idx]["CLASS_CODE"].ToString()));
            }
        }
        ...
        protected void GetQueryPortalet(object sender, AjaxEventArgs e)
        {
            ...
            Currdt = dal.getDeptOutpOrdes(dd1.Replace("-", ""), dd2.Replace("-", ""), this.DeptFilter(""), this.DeptCodeCombo.SelectedItem.Value, this.cboType.SelectedItem.Value).Tables[0];
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            ExcelTable = Currdt;
            ex.ExportToLocal(ExcelTable, this.Page, "xls", "门诊处方明细查询");
        }
