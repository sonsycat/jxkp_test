...
{
    public partial class DeptIncomeNoSettle : PageBase
    {
        ...
        protected void GetQueryPortalet(object sender, AjaxEventArgs e)
        {
            ...
            //string FromDate = this.Comb_StartYear.SelectedItem.Value + month;
            ...
            //string ToDate = this.Comb_EndYear.SelectedItem.Value + month;
            Currdt = dal.GetDeptIncomeNoSettle(dd1.Replace("-",""), dd2.Replace("-",""), this.cbxType.SelectedItem.Value,
                                    this.DeptFilter(""), l_dt, "PER_CLASS_COSTS_NO_SETTLE").Tables[0];
        ...
        protected void GetQueryPer(object sender, AjaxEventArgs e)
        {
            ...
            PageResponse(this.getPageResponseUrl("PerIncomeNosettle.aspx", dd1.Replace("-",""), dd2.Replace("-",""), this.cbxType.SelectedItem.Value, selectRow[0]["科室编码"].ToString()), "出院未结病人费用明细---" + selectRow[0]["科室名称"].ToString());
        }
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            ExcelTable = Currdt;
            ex.ExportToLocal(ExcelTable, this.Page, "xls", "出院未结病人费用");
        }
