...
{
    public partial class PerformDeptIncome : PageBase
    {
        ...
        public void Data_RefreshData(object sender, StoreRefreshDataEventArgs e)
        {
            ...
            Currdt = dal.getPerformDeptIncome(dd1, dd2,this.DeptCodeCombo.SelectedItem.Value, this.DeptFilter("")).Tables[0];
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            ExcelTable = Currdt;
            ex.ExportToLocal(ExcelTable, this.Page, "xls", "科室执行收入");
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void QueryPerformDeptIncomeInfo(object sender, AjaxEventArgs e)
        {
            string col = e.ExtraParams["col"].ToString();
            Dictionary<string, string>[] selectRow = GetSelectRow(e);
            //判断如果selectRow里为null，则返回空
            if (Convert.ToInt32(col) < 2 || selectRow[0]["CLASS_CODE"].Equals("999999"))
            {
                return;
            }
            ...
            PageResponse(getPageResponseUrl("PerformIncomeInfo.aspx", dd1, dd2, col, this.DeptCodeCombo.SelectedItem.Value, selectRow[0]["CLASS_CODE"]), "药品明细");
        }
        ...
        private string getPageResponseUrl(string PageUrl, string fromDate, string toDate, string type, string deptCode, string ClassCode)
        {
            string ResponseUrl = "" + PageUrl + "?DeptCode=" + deptCode + "&FromDate=" + fromDate + "&ToDate=" + toDate + "&Type=" + type + "&ClassCode=" + ClassCode;
            return ResponseUrl;
        }
    }
}
