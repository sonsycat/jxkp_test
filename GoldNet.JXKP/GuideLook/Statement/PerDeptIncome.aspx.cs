...
{
    public partial class PerDeptIncome : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                Currdt = dal.GetPerIncomeNoSettle(fromDate, ToDate, deptCode, Type, l_dt, "PER_CLASS_COSTS").Tables[0];
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            ExcelTable = Currdt;
            ex.ExportToLocal(ExcelTable, this.Page, "xls", "住院结算病人费用明细");
        }
    }
}
