...
{
    public partial class DeptByMonthReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Ext.IsAjaxRequest)
            {
                ...
                DataTable ReportInfo = dal.getDeptByMonthReport(dd1, dd2, GuideCode, DeptCode, "K", reportid).Tables[0];
