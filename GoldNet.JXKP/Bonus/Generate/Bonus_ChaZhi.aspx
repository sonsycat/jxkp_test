<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bonus_ChaZhi.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Generate.Bonus_ChaZhi" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var getRecordFilter = function () {
            ...
            f.push({
                filter: function (record) {
                    return filterString(txt_SearchTxt.getValue(), 'USER_TOTAL_BONUS', record);
                }
            });
            f.push({
                filter: function (record) {
                    return filterNumber(txt_SearchTxt.getValue(), 'SF', record);
                }
            });
            f.push({
                filter: function (record) {
                    return filterString(txt_SearchTxt.getValue(), 'CHAZHI', record);
                }
            });
                            ...
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="SSearch" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="USER_TOTAL_BONUS" Header="二次分配合计" Width="100" DataIndex="USER_TOTAL_BONUS" MenuDisabled="true"
                                            Align="Center">
                                        </ext:Column>
                                        <ext:Column ColumnID="SF" Header="<div style='text-align:center;'>科室绩效实发</div>"
                                            Width="100" DataIndex="SF" MenuDisabled="true" Align="Right">
                                        </ext:Column>
                                        <ext:Column ColumnID="CHAZHI" Header="差值" Width="200" DataIndex="CHAZHI" MenuDisabled="true"
                                            Align="Center">
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
