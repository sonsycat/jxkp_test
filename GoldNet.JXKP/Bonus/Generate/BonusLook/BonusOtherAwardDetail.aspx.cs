...
{
    public partial class BonusOtherAwardDetail : PageBase
    {
        //------------------------------------------------------------
        //1、科室其他奖惩明细
        //
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Ext.IsAjaxRequest)
            {
                ...
                //查询科室其他奖惩明细
                DataTable dtOtherAward = lookDeptBonus.GetOtherAwardDetail(Years, Months, dept_code);
        ...
        protected void Btn_Back(object sender, AjaxEventArgs e)
        {
            ...
            string deptType = this.GetStringByQueryStr("DeptType");
