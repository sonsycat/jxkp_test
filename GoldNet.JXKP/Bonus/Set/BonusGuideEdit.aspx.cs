...
{
    public partial class BonusGuideEdit : PageBase
    {
        private Goldnet.Dal.BonusGuideDict dal = new Goldnet.Dal.BonusGuideDict();
        ...
        private void SetInitState(object selectedRow)
        {
            ...
            if (selectedRow == null)
            {
                ...
                this.BSC1Comb.SelectedIndex = 1;
                SelectedBSC1(null, null);
                this.BSC2Comb.SelectedIndex = 11;
                SelectedBSC2(null, null);
            ...
            else
            {
                ...
                this.IsHighComb.Value = row["ISHIGHGUIDE"].Equals("是") ? "1" : "0";
                ...
                this.cbbType.Value = row["ISSAME"];
                this.TextField2.Value = row["SHOWNUM"];
                this.TextAreaexplain.Value = row["EXPLAIN"];
                if (row["INDEXTYPE"] == null)
                {
                    this.zbType.Value = "0";
                }
                else
                {
                    this.zbType.Value = row["INDEXTYPE"].Equals("通用") ? "0" : (row["INDEXTYPE"].Equals("临床") ? "1" : "2");
                }
