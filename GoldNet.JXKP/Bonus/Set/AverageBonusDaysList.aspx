<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AverageBonusDaysList.aspx.cs"
    Inherits="GoldNet.JXKP.AverageBonusDaysList" %>
...
<body>
    ...
    <ext:Store ID="Store1" AutoLoad="true" runat="server">
        <Reader>
            <ext:JsonReader ReaderID="YEAR_MONTH">
                <Fields>
                    <ext:RecordField Name="YEAR_MONTH">
                    </ext:RecordField>
