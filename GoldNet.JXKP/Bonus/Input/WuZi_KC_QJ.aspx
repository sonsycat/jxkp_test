<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WuZi_KC_QJ.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.WuZi_KC_QJ" %>
    ...
    <div>
        ...
        <ext:Store ID="Store1" runat="server" AutoLoad="true" OnRefreshData="Store_RefreshData">
            <Reader>
                <ext:JsonReader >
                    <Fields> 
                        <ext:RecordField Name="GEGIN_DATE" />  
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="开始时间" Width="100" Align="Left" Sortable="true"  MenuDisabled="true" 
                                            ColumnID="GEGIN_DATE" DataIndex="GEGIN_DATE" Hidden="false">
                                        </ext:Column>
                                        <ext:Column Header="结束时间" Width="100" Align="Left" Sortable="true"  MenuDisabled="true" 
                                            ColumnID="END_DATE" DataIndex="END_DATE" Hidden="false">
                                        </ext:Column>
                                        ...
                                        <ext:Column Header="区间期初数量" Width="100" Align="left" Sortable="true" MenuDisabled="true"
                                            ColumnID="QC_AMOUNT" DataIndex="QC_AMOUNT">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                         <ext:Column Header="区间申请数量" Width="100" Align="Left" Sortable="true"  MenuDisabled="true" 
                                            ColumnID="INP_AMOUNT" DataIndex="INP_AMOUNT" Hidden="false">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                         <ext:Column Header="区间使用数量" Width="100" Align="Left" Sortable="true"  MenuDisabled="true" 
                                            ColumnID="OUT_AMOUNT" DataIndex="OUT_AMOUNT" Hidden="false">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                         <ext:Column Header="区间库存数量" Width="100" Align="Left" Sortable="true"  MenuDisabled="true" 
