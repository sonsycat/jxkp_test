<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SingleAwardList.aspx.cs"
    Inherits="GoldNet.JXKP.SingleAwardList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
          ...
          var getRecordFilter = function() {
              ...
              f.push({
                  filter: function(record) {
                  return filterString(txt_SearchTxt.getValue(), 'TYPENAME', record);
                  }
              });
              f.push({
                  filter: function(record) {
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                    ...
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <AjaxEvents>
                                             ...
                                             <ext:Button ID="Btn_Search" runat="server" Text="条件查询" Icon="FolderMagnify">
                                            <AjaxEvents>
                                                 <Click OnEvent="Btn_Search_Click">
                                                 </Click>
                                             </AjaxEvents>    
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        <ext:Column ColumnID="AWARDDATE" Header="奖惩时间" Width="200" DataIndex="AWARDDATE"
                                            MenuDisabled="true" Align="Center">
                                        </ext:Column>
                                        <ext:Column ColumnID="DEPTNAME" Header="奖惩科室" Width="200" DataIndex="DEPTNAME" MenuDisabled="true"
                                            Align="Center">
                                        </ext:Column>
                                        <ext:Column ColumnID="TYPENAME" Header="<div style='text-align:center;'>奖惩项目</div>"
                                            Width="200" DataIndex="TYPENAME" MenuDisabled="true" Align="center">
                                        </ext:Column>
