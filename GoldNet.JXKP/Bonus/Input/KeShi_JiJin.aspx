<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KeShi_JiJin.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.KeShi_JiJin" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var Btnwindow = function () {
            document.getElementById('BtnWindow').click();
        }
        ...
        var getRecordFilter = function () {
            ...
            f.push({
                filter: function (record) {
                    return filterDate(txt_SearchTxt.getValue(), 'AWARDDATE', record);
                }
            });            
            f.push({
                filter: function (record) {
            ...
            f.push({
                filter: function (record) {
                    return filterNumber(txt_SearchTxt.getValue(), 'SY_MONEY', record);
                }
            });
...
<body>
        ...
        <Reader>
            <ext:JsonReader ReaderID="ID">
                <Fields>
                    ...
                    <ext:RecordField Name="AWARDDATE">
                    </ext:RecordField>                   
                    <ext:RecordField Name="MONEY">
                    </ext:RecordField>
                    <ext:RecordField Name="SY_MONEY">
                    </ext:RecordField>
                </Fields>
            </ext:JsonReader>
        </Reader>
    ...
    <div>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:Button ID="BtnWindow" runat="server" Text="弹窗" Icon="FolderMagnify" Hidden="true">
                                            <AjaxEvents>
                                                 <Click OnEvent="Btn_Window">
                                                 </Click>
                                             </AjaxEvents>                                             
                                            </ext:Button>
                                        </Items>
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        <ext:Column ColumnID="AWARDDATE" Header="时间" Width="200" DataIndex="AWARDDATE"
                                            MenuDisabled="true" Align="Center">
                                        </ext:Column>
                                        <ext:Column ColumnID="DEPTNAME" Header="科室" Width="200" DataIndex="DEPTNAME" MenuDisabled="true"
                                            Align="Center">
                                        </ext:Column>                                        
                                        <ext:Column ColumnID="MONEY" Header="<div style='text-align:center;'>科基金金额</div>"
                                            Width="200" DataIndex="MONEY" MenuDisabled="true" Align="Right">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <ext:Column ColumnID="SY_MONEY" Header="<div style='text-align:center;'>科基金余额</div>"
                                            Width="200" DataIndex="SY_MONEY" MenuDisabled="true" Align="Right">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
                                    ...
                                    <ext:Toolbar ID="Toolbar1" runat="server">
                                        <Items>
                                            ...
                                            <ext:TextField ID="txt_SearchTxt" runat="server" EmptyText="查找">
                                                <ToolTips>
                                                    <ext:ToolTip ID="ToolTip1" runat="server" Html="根据奖惩时间，奖惩科室，奖惩项目模糊查找">
                                                    </ext:ToolTip>
                                                </ToolTips>
                                            </ext:TextField>
        ...
        <ext:Window ID="DetailWin" runat="server" Icon="Group" Title="单项奖惩录入" Width="440"
            Height="480" AutoShow="false" Modal="true" CenterOnLoad="true" AutoScroll="true"
            ShowOnLoad="false" Resizable="false" StyleSpec="background-color:Transparent;"
            BodyStyle="background-color:Transparent;">
        </ext:Window>
       <%-- <ext:Window ID="Search" runat="server" Icon="Group" Title="单项奖惩录入查询" Width="460"
