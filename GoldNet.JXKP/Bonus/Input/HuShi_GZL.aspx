<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuShi_GZL.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.HuShi_GZL" %>
                                        ...
                                        <ext:LayoutColumn ColumnWidth="1">
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>                                                        
                                                        <ext:Column Header="项目编码" Width="100" Align="Center" Sortable="false" MenuDisabled="true"
