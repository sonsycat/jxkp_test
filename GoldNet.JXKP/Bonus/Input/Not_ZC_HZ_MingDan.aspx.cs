...
{
    public partial class Not_ZC_HZ_MingDan : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Store1.DataSource = dal.getNot_MingDan().Tables[0];
        ...
        {
            Store1.RemoveAll();
            Store1.DataSource = dal.getNot_MingDan().Tables[0];
            Store1.DataBind();
        }
        ...
        public void DictAjaxOper(string DictCode, string DictName, string OperType, string Subsidy, string Sortno)
        {
            ...
            {
                case "1":
                    dal.InsertNot_MingDan(DictCode);
                    break;
                case "2":
                    dal.UpdataNot_MingDan(DictCode);
                    break;
                case "3":
                    dal.DelNot_MingDan(DictCode);
                    break;
            }
        }
    }
