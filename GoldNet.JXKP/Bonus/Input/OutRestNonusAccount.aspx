<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutRestNonusAccount.aspx.cs"
    Inherits="GoldNet.JXKP.Bonus.Input.OutRestNonusAccount" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="FORMAL_AM">
                    </ext:RecordField>
                    <ext:RecordField Name="FORMAL_PM">
                    </ext:RecordField>
                    <ext:RecordField Name="TEMPORARY_AM">
                    </ext:RecordField>
                    <ext:RecordField Name="TEMPORARY_PM">
                    </ext:RecordField>
                    <ext:RecordField Name="SUMNUB">
                    </ext:RecordField>
                </Fields>
            </ext:JsonReader>
        </Reader>
                                    ...
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0">
                                        <Items>
                                            ...
                                            <ext:Button ID="btn_Query" runat="server" Text="查询" Icon="Zoom">
                                                <AjaxEvents>
                                                    <Click OnEvent="Btn_Query_Click" Timeout="20000000">
                                ...
                                <Body>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="SReport" Border="true"
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:ExtColumn ColumnID="ST_DATE" Header="<div style='text-align:center;'>时间</div>"
                                                    Width="120" DataIndex="ST_DATE" MenuDisabled="true">
                                                </ext:ExtColumn>
                                                ...
                                                <ext:ExtColumn ColumnID="FORMAL_AM" Header="<div style='text-align:center;'>正式上午</div>"
                                                    Width="120" DataIndex="FORMAL_AM" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="FORMAL_PM" Header="<div style='text-align:center;'>正式下午</div>"
                                                    Width="120" DataIndex="FORMAL_PM" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="TEMPORARY_AM" Header="<div style='text-align:center;'>临时上午</div>"
                                                    Width="120" DataIndex="TEMPORARY_AM" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="TEMPORARY_PM" Header="<div style='text-align:center;'>临时下午</div>"
                                                    Width="120" DataIndex="TEMPORARY_PM" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="SUMNUB" Header="<div style='text-align:center;'>合计</div>"
                                                    Width="120" DataIndex="SUMNUB" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                            </Columns>
                                        </ExtColumnModel>
