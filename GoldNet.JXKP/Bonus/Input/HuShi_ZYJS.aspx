<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuShi_ZYJS.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.HuShi_ZYJS" %>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_ZLJK" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                             ...
                                             <ext:ComboBox ID="dept_SelectDept" runat="server" AllowBlank="true"  Width="120" EmptyText="请选择科室"  FieldLabel="科室选择">
                                             </ext:ComboBox>
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="科室编码" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="DEPT_NAME" DataIndex="DEPT_NAME" Hidden="false">
                                        </ext:Column>
                                        <ext:Column Header="收入" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                        ...
                                        <ext:Column Header="项目编码" Width="150" Align="left" Sortable="true" MenuDisabled="true"
                                         ...
                                         <ext:Column Header="来源" Width="100" Align="left" Sortable="true" MenuDisabled="true"
                                            ColumnID="LY" DataIndex="LY">
                                        </ext:Column>                                                                               
                                    </Columns>
                                </ColumnModel>
                                <SelectionModel>
