...
{
    public partial class SingleAwardList : PageBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        protected void data(string datetime)
        {
            ...
            table = inputSingleAward.GetSingleAwardList(conditin, user,datetime);
        ...
        protected void Btn_Edit_Click(object sender, AjaxEventArgs e)
        {
            ...
            if (selectRow != null)
            {
                ...
                LoadConfig loadcfg = getLoadConfig("SingleAwardEdit.aspx");
        ...
        protected void buttonsearche(object sender, AjaxEventArgs e)
        {
            ...
            User user = (User)Session["CURRENTSTAFF"];
            DataTable table = new DataTable();
            table = inputSingleAward.GetSingleAwardList(conditin, user, GetBeginDate());
