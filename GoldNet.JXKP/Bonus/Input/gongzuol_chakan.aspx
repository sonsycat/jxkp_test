<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gongzuol_chakan.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.gongzuol_chakan" %>
                ...
                <ext:JsonReader >
                    <Fields>
                       ...
                       <ext:RecordField Name="CLASS_NAME" />
                        ...
                        <ext:RecordField Name="ITEM_UNIT" />
                       <ext:RecordField Name="ITEM_PRICE" />
                        <ext:RecordField Name="PANDU" />  
                         <ext:RecordField Name="ZHIXING" />                     
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="核算科室名称" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="DEPT_NAME" DataIndex="DEPT_NAME" Hidden="false">
                                        </ext:Column>
                                        <ext:Column Header="核算科室编码" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="DEPT_CODE" DataIndex="DEPT_CODE" Hidden="false">
                                        </ext:Column>
                                         <ext:Column Header="核算类别" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="CLASS_NAME" DataIndex="CLASS_NAME" Hidden="false">
                                        </ext:Column>
                                        <ext:Column Header="项目编码" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="ITEM_CODE" DataIndex="ITEM_CODE" Hidden="false">
                                        </ext:Column>
                                         <ext:Column Header="项目名称" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="ITEM_NAME" DataIndex="ITEM_NAME" Hidden="false">
                                        </ext:Column>
                                        <ext:Column Header="规格型号" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="ITEM_UNIT" DataIndex="ITEM_UNIT" Hidden="false">
                                        </ext:Column>
                                        <ext:Column Header="单价" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="ITEM_PRICE" DataIndex="ITEM_PRICE">
                                        </ext:Column>
                                        <ext:Column Header="判读点值" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="PANDU" DataIndex="PANDU">
                                        </ext:Column>
                                         <ext:Column Header="执行点值" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="ZHIXING" DataIndex="ZHIXING">
                                        </ext:Column>                                
                                    </Columns>
                                </ColumnModel>
                                <SelectionModel>
