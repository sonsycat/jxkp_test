<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cy_Select.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.Cy_Select" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="人员姓名" />
               <%--     <ext:RecordField Name="收入项目" />--%>
                </Fields>
            </ext:JsonReader>
        </Reader>
    </ext:Store>
                            ...
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="人员姓名" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="人员姓名" DataIndex="人员姓名" Hidden="false">
                                        </ext:Column>
                                      <%--    <ext:Column Header="收入项目" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="收入项目" DataIndex="收入项目" Hidden="false">
                                        </ext:Column>--%>
                                        <ext:Column Header="金额" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="金额" DataIndex="金额">
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
                                <SelectionModel>
