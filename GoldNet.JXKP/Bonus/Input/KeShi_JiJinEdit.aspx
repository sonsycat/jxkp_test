<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KeShi_JiJinEdit.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.KeShi_JiJinEdit" %>
            ...
            <Body>
                ...
                <ext:FormLayout ID="FormLayout1" runat="server" LabelWidth="80">
                    <ext:Anchor Horizontal="70%">
                        <ext:DateField runat="server" ID="dfInputDate" CausesValidation="true" FieldLabel="时间" 
                    ...
                    <ext:Anchor Horizontal="70%">
                        <ext:NumberField runat="server" ID="nfNumber" CausesValidation="true"  FieldLabel="科基金金额"
                    ...
                    <ext:Anchor Horizontal="70%">
                        <ext:ComboBox ID="ccbtype" runat="server" StoreID="Store2" DisplayField="TYPENAME"
                            ValueField="TYPEID" Width="240" FieldLabel="奖惩项目"  CausesValidation="true"  Hidden="true">
                            <AjaxEvents>
                    ...
                    <ext:Anchor Horizontal="95%">
                        <ext:TextArea runat="server" ID="taCheckStan" FieldLabel="标准"  Height="80" Hidden="true"/>
                    </ext:Anchor>
                    <ext:Anchor Horizontal="95%">
