<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZhenCha_ChaXun.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.ZhenCha_ChaXun" %>
            ...
            <Reader>
                <ext:JsonReader >
                    <Fields>
                        ...
                        <ext:RecordField Name="MZZCF" />
                        <ext:RecordField Name="JRZCF" />
                        <ext:RecordField Name="HZF" />
                            ...
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_ZLJK" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                             <ext:Label ID="Label1" runat="server" Text="绩效日期：" />
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="医生名称" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="USER_NAME" DataIndex="USER_NAME">
                                        </ext:Column>
                                        <ext:Column Header="门诊诊查费提成" Width="100" Align="left" Sortable="true" MenuDisabled="true"
                                            ColumnID="MZZCF" DataIndex="MZZCF">
                                        </ext:Column>
                                        <ext:Column Header="门诊假日诊察提成" Width="150" Align="left" Sortable="true" MenuDisabled="true"
                                            ColumnID="JRZCF" DataIndex="JRZCF">
                                        </ext:Column>
                                         <ext:Column Header="会诊费提成" Width="150" Align="left" Sortable="true" MenuDisabled="true"
                                            ColumnID="HZF" DataIndex="HZF">
                                        </ext:Column>
                                        <ext:Column Header="合计" Width="150" Align="left" Sortable="true" MenuDisabled="true"
                                            ColumnID="HJ" DataIndex="HJ">
                                        </ext:Column>                                                                 
                                    </Columns>
                                </ColumnModel>
                                <SelectionModel>
