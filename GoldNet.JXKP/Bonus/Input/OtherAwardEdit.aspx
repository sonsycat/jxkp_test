<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherAwardEdit.aspx.cs" Inherits="GoldNet.JXKP.OtherAwardEdit" %>
...
<body>
    ...
    <div>
        <ext:FormPanel ID="FormPanel1" runat="server" Border="false" AutoScroll="false" ButtonAlign="Right"
            StyleSpec="background-color:Transparent" BodyStyle="background-color:Transparent;Transparent;margin:10px,0,0,10px">
            <Body>
             <ext:Resizable ID="Resizable3" runat="server" Element="taReason" Handles="South" Wrap="true" Pinned="true" Height="96"  MinHeight="60" Dynamic="true" />
                <ext:FormLayout ID="FormLayout1" runat="server" LabelWidth="80">
                    <ext:Anchor Horizontal="70%">
                        <ext:DateField runat="server" ID="dfInputDate" CausesValidation="true" FieldLabel="奖惩时间" AllowBlank="false" Format="yyyy-MM-dd" MaxLength="10" EnableKeyEvents="true">
                             <Listeners>
                                    <KeyDown Fn="KedDown" />
                                     <Change Fn="dept_date" /> 
                                </Listeners>
                    ...
                    <ext:Anchor Horizontal="70%">
                     ...
                     <ext:Anchor Horizontal="70%">
                        <ext:ComboBox ID="ccbtype" runat="server" StoreID="Store2" DisplayField="TYPENAME"
                            ...
                            <AjaxEvents>
                                <Select OnEvent="TypeSelect"></Select>
                            </AjaxEvents>                        
                        </ext:ComboBox>
                       
                    </ext:Anchor>
                    <ext:Anchor Horizontal="95%">
                        <ext:TextArea runat="server" ID="taReason"  FieldLabel="奖惩原因"  Height="80" />
                    </ext:Anchor>
                    <ext:Anchor Horizontal="70%">
            ...
            <Buttons>
                <ext:Button ID="BtnSave" runat="server" Text="保存" Icon="Disk">
                    <AjaxEvents>
                        <Click OnEvent="SaveEditOtherAward" Before="if (CheckForm()== false){ Ext.Msg.alert('系统提示','请根据红线提示填写正确的信息！');return false;};">
                        </Click>
                    </AjaxEvents>
                </ext:Button>
