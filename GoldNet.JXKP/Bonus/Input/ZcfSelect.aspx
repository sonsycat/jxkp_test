<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZcfSelect.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.ZcfSelect" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="项目数量" />
                    <%-- <ext:RecordField Name="单价" />--%>
                    <ext:RecordField Name="分值" />
                    <ext:RecordField Name="人员名称" />
                            ...
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    ...
                                    <Columns>
                                        ...
                                        <ext:Column Header="人员名称" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="人员名称" DataIndex="人员名称" Hidden="false">
                                        </ext:Column>
                                          <ext:Column Header="项目名称" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="项目名称" DataIndex="项目名称" Hidden="false">
                                        </ext:Column>
                                           <ext:Column Header="项目数量" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="项目数量" DataIndex="项目数量" Hidden="false">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <%--     <ext:Column Header="单价" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="单价" DataIndex="单价" Hidden="false" >
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>--%>
