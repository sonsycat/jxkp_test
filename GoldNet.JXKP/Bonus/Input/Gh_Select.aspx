<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gh_Select.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.Gh_Select" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="执行人" />
                    <ext:RecordField Name="统筹报销" />
                    <ext:RecordField Name="个人账户支付" />
                    <ext:RecordField Name="现金" />
                    <ext:RecordField Name="总额" />
                </Fields>
            </ext:JsonReader>
        </Reader>
    </ext:Store>
                            ...
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="执行人" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="执行人" DataIndex="执行人" Hidden="false">
                                        </ext:Column>
                                          <ext:Column Header="统筹报销" Width="150" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="统筹报销" DataIndex="统筹报销" Hidden="false">
                                        </ext:Column>
                                        <ext:Column Header="个人账户支付" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="个人账户支付" DataIndex="个人账户支付">
                                        </ext:Column>
                                           <ext:Column Header="现金" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="现金" DataIndex="现金">
                                        </ext:Column>
                                           <ext:Column Header="总额" Width="100" Align="Left" Sortable="true" MenuDisabled="true"
                                            ColumnID="总额" DataIndex="总额">
                                        </ext:Column>
