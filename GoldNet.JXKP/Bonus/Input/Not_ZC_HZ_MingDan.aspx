<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Not_ZC_HZ_MingDan.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.Not_ZC_HZ_MingDan" %>
        ...
        */
        function TreeOpration(optype) {
            if (optype == "1") {
                ...
                txtCode.setValue(this.Store1.getAt(RowIndex).get('USER_ID'));                
                Btn_BatStart.setText("修改");
                arcEditWindow.show();
            } else if (optype == "3") {
                Btn_BatStart.setText("");
                Ext.Msg.confirm("删除项目", "确定要删除该项目：" + this.Store1.getAt(RowIndex).get('USER_ID') + " 吗？", function (btn, text) { OpCallback(btn) });
            }
        }
        ...
        */
        function OpCallback(btn) {
            ...
            if (optype == "1") {
                ...
                GridPanelToDataBase(this.Store1.getAt(RowIndex).get('USER_ID'), code, name, optype, a1, a2);
            } else if (optype == "3") {
                GridPanelToDataBase(this.Store1.getAt(RowIndex).get('USER_ID'), this.Store1.getAt(RowIndex).get('USER_ID'), "", optype, a1, a2);
            }
        }
...
<body>
                    ...
                    <North>
                        <ext:Toolbar runat="server" ID="ctl155" StyleSpec="border:0">
                            <Items>
                                ...
                                <ext:Button Text="修改" ID="btn_Modify" runat="server" Icon="FolderEdit" Disabled="true" Hidden="true">
                                    <Listeners>
                                        ...
                                        <ext:LayoutColumn ColumnWidth="1">
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        <ext:Column Header="医生名称" Width="100" Align="Center" Sortable="false" MenuDisabled="true"
                                                            ColumnID="USER_NAME" DataIndex="USER_NAME" />
                                                        <ext:Column Header="医生工号" Width="150" Align="Center" Sortable="false" MenuDisabled="true"
    ...
    <ext:Window ID="arcEditWindow" runat="server" Icon="Group" Title="设置名单" Width="250"
