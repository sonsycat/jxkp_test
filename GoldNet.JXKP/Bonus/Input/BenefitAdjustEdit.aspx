<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BenefitAdjustEdit.aspx.cs" Inherits="GoldNet.JXKP.BenefitAdjustEdit" %>
...
<body>
    ...
    <div>
        <ext:FormPanel ID="FormPanel1" runat="server" Border="false" AutoScroll="false" ButtonAlign="Right"
            ...
            <Body>
                <ext:Resizable ID="Resizable3" runat="server" Element="taMEMO" Handles="South" Wrap="true" Pinned="true" Height="96"  MinHeight="60" Dynamic="true" />
                <ext:FormLayout ID="FormLayout1" runat="server" LabelWidth="80" >
                     <ext:Anchor Horizontal="70%">
                        <ext:DateField runat="server" ID="dfInputDate" CausesValidation="true" FieldLabel="调整时间"
                    ...
                    <ext:Anchor Horizontal="70%">
                        <ext:ComboBox ID="cbbdept" runat="server" StoreID="Store3" DisplayField="DEPT_NAME" 
                            ...
                            PageSize="10" ItemSelector="div.search-item" MinChars="1" FieldLabel="科室信息" ListWidth="240"  CausesValidation="true" AllowBlank="false">
                    ...
                    <ext:Anchor Horizontal="70%">
                        <ext:RadioGroup ID="rgType" runat="server" FieldLabel="调整类别" ColumnsNumber="2" ItemCls="x-check-group-alt">
                            <Items>
                     ...
                     <ext:Anchor Horizontal="70%">                        
                        <ext:NumberField runat="server" ID="nfNumber" CausesValidation="true" FieldLabel="调整金额"
                            Text="0" AllowBlank="false" SelectOnFocus="true" DecimalPrecision="2" StyleSpec="text-align:right">
                        </ext:NumberField>
                    </ext:Anchor>
                     <ext:Anchor Horizontal="95%">
                        <ext:TextArea runat="server" ID="taMEMO"  FieldLabel="调整说明" Height="100" />                      
                    </ext:Anchor>
                    <ext:Anchor Horizontal="70%">
                        <ext:RadioGroup ID="rgDirection" runat="server" FieldLabel="调整方向"  ColumnsNumber="2"
            ...
            <Buttons>
                <ext:Button ID="BtnSave" runat="server" Text="保存" Icon="Disk">
                    <AjaxEvents>
                        <Click OnEvent="Save" Before="if (CheckForm()== false){ Ext.Msg.alert('系统提示','请根据红线提示填写正确的信息！');return false;};">
                        </Click>
                    </AjaxEvents>
                </ext:Button>
