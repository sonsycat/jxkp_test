<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualitySearchByDate.aspx.cs"
    Inherits="GoldNet.JXKP.zlgl.SysManage.QualitySearchByDate" %>
...
<body>
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_guidetype" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="date" runat="server" AllowBlank="false" StoreID="Store3" Width="100" DisplayField="DATEDESC"
                                            ValueField="ID" ReadOnly="true" EmptyText="选择时间">
                                            </ext:ComboBox>
                                            ...
                                            <ext:Button ID="Buttonedit" runat="server" Text="查询" Icon="Zoom">
                                             ...
                                             <ext:Button ID="buidequality" runat="server" Text="生成质量数据" Icon="Build" Visible="false">
                                                <AjaxEvents>
    ...
    <ext:Window ID="guideDetail" runat="server" Icon="Group" Title="科室分项得分" Width="800" Height="500" AutoShow="false" Modal="true" CenterOnLoad="true" AutoScroll="true"
     ...
     <ext:Window ID="BuideWin" runat="server" Icon="Add" Title="生成质量数据" Width="600"
            Height="400"  AutoShow="false" Modal="true"  CenterOnLoad="true" AutoScroll="false" ShowOnLoad="false" Closable="false" Resizable="false" StyleSpec="background-color:Transparent;" BodyStyle="background-color:Transparent;" CloseAction="Hide">
  </ext:Window>
    </form>
</body>
</html>
