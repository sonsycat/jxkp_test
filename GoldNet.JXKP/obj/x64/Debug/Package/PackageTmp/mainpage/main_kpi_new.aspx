<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main_kpi_new.aspx.cs" Inherits="GoldNet.JXKP.mainpage.main_kpi_new" %>
    ...
    <div>
        <ext:Panel ID="Panel1" runat="server" Border="false" MonitorResize="true">
            <Body>
                <center>
                    <br>
                    <img src='/mainpage/TempImages/GaugePic1.png?temp=1<%= DateTime.Now.Ticks.ToString()%>''
