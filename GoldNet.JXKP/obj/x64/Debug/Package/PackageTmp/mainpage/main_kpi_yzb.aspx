<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main_kpi_yzb.aspx.cs" Inherits="GoldNet.JXKP.mainpage.main_kpi_yzb" %>
    ...
    <div>
        <ext:Panel ID="Panel1" runat="server" Border="false" MonitorResize="true">
            <Body>
                <center>
                    <br>
                    <img src='/mainpage/TempImages/GaugePic3.png?temp=3<%= DateTime.Now.Ticks.ToString()%>''
