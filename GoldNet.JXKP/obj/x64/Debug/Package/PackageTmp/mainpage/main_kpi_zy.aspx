<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main_kpi_zy.aspx.cs" Inherits="GoldNet.JXKP.mainpage.main_kpi_zy" %>
    ...
    <div>
        <ext:Panel ID="Panel1" runat="server" Border="false" MonitorResize="true">
            <Body>
                <center>
                    <br>
                    <img src='/mainpage/TempImages/GaugePic4.png?temp=4<%= DateTime.Now.Ticks.ToString()%>'
