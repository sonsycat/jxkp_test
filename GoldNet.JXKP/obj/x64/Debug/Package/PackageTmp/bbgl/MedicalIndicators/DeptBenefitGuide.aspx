<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptBenefitGuide.aspx.cs" Inherits="GoldNet.JXKP.bbgl.MedicalIndicators.DeptBenefitGuide" %>
  ...
  <TopBar>
               <ext:Toolbar ID="Toolbar_ZLJK" runat="server" Visible="true">
                   <Items>
                       ...
                       <ext:Button ID="Button1" runat="server" Text=" 查询 " Icon="FolderMagnify">
                        <AjaxEvents>
                       ...
                       <ext:ToolbarSeparator ID="ToolbarSeparator4" runat="server" />
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="<center>编制床</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="65">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>展开床</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="65">
                                            
                                        </ext:Column>
                                        <ext:Column Header="<center>编制床使用率</center>" Sortable="true" ColumnID="Columns4" DataIndex="Columns4" 
                                            Align="center" Width="85">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>展开床使用率</center>" Sortable="true" ColumnID="Columns5" DataIndex="Columns5"
                                            Align="center" Width="85">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        ...
                                        <ext:Column Header="<center>床位周转次数</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="95">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>占床总日数</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="77">
                                        ...
                                        <ext:Column Header="<center>平均每日占床数</center>" Sortable="true" ColumnID="Columns6" DataIndex="Columns6" Align="center" Width="100">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                        
                                        <ext:Column Header="<center>军队病人平均每日占床数</center>" Sortable="true" ColumnID="Columns7" DataIndex="Columns7"
                                            Align="center" Width="151">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                         <ext:Column Header="<center>地方病人平均每日占床数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="151">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                         <ext:Column Header="<center>平均日住院手术例数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="122">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                       <ext:Column Header="<center>每百床日手术指数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
