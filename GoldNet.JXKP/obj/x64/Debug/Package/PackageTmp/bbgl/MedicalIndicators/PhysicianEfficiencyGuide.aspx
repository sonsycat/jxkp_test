<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhysicianEfficiencyGuide.aspx.cs" Inherits="GoldNet.JXKP.bbgl.MedicalIndicators.PhysicianEfficiencyGuide" %>
                       ...
                       <ext:ToolbarSeparator ID="ToolbarSeparator4" runat="server" />
                                    ...
                                    <Columns>
                                        ...
                                        <ext:Column Header="<center>科室</center>" Sortable="true" ColumnID="Columns1" DataIndex="Columns1"
                                            Align="center" Width="97">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>军人(入院)</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="67">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>地方(入院)</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="67">
                                            
                                        </ext:Column>
                                        <ext:Column Header="<center>小计(入院)</center>" Sortable="true" ColumnID="Columns4" DataIndex="Columns4" 
                                            Align="center" Width="67">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>占全科%(入院)</center>" Sortable="true" ColumnID="Columns5" DataIndex="Columns5"
                                            Align="center" Width="87">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        ...
                                        <ext:Column Header="<center>军人(出院)</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="67">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>地方(出院)</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="67">
                                            
                                        </ext:Column>
                                        <ext:Column Header="<center>小计(出院)</center>" Sortable="true" ColumnID="Columns4" DataIndex="Columns4" 
                                            Align="center" Width="67">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>占全科%(出院)</center>" Sortable="true" ColumnID="Columns5" DataIndex="Columns5"
                                            Align="center" Width="87">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        ...
                                        <ext:Column Header="<center>出院者住院总日数</center>" Sortable="true" ColumnID="Columns6" DataIndex="Columns6" Align="center" Width="109">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                        
                                        <ext:Column Header="<center>出院者平均住院日</center>" Sortable="true" ColumnID="Columns7" DataIndex="Columns7"
                                            Align="center" Width="104">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                         <ext:Column Header="<center>出院者治愈总日数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="114">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                         <ext:Column Header="<center>出院者平均治愈天数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="116">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                       <ext:Column Header="<center>平均术前住院日</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="114">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
