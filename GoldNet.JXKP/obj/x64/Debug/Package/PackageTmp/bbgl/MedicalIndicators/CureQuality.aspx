<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CureQuality.aspx.cs" Inherits="GoldNet.JXKP.bbgl.MedicalIndicators.CureQuality" %>
                       ...
                       <ext:ToolbarSeparator ID="ToolbarSeparator4" runat="server" />
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="<center>抢救病人<br>住院抢救人次</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="90">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>抢救病人<br>住院抢救成功人次</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="110">
                                            
                                        </ext:Column>
                                        <ext:Column Header="<center>抢救病人<br>抢救成功率</center>" Sortable="true" ColumnID="Columns4" DataIndex="Columns4" 
                                            Align="center" Width="76">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>危重病人<br>病危人数</center>" Sortable="true" ColumnID="Columns5" DataIndex="Columns5"
                                        ...
                                        <ext:Column Header="<center>危重病人<br>病危天数</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="66">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>危重病人<br>病重人数</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="66">
                                        ...
                                        <ext:Column Header="<center>危重病人<br>病重天数</center>" Sortable="true" ColumnID="Columns6" DataIndex="Columns6" Align="center" Width="66">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                        
                                        <ext:Column Header="<center>危重病人<br>危重人数占全科</center>" Sortable="true" ColumnID="Columns7" DataIndex="Columns7"
                                            Align="center" Width="100">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                         <ext:Column Header="<center>危重病人<br>危重天数占全科</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="100">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                         <ext:Column Header="<center>分级护理天数<br>特级护理天数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="132">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>

                                         <ext:Column Header="<center>分级护理天数<br>一级护理天数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="132">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>分级护理天数<br>二级护理天数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="132">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
