<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperationgCircs.aspx.cs" Inherits="GoldNet.JXKP.bbgl.MedicalIndicators.OperationgCircs" %>
                       ...
                       <ext:ToolbarSeparator ID="ToolbarSeparator4" runat="server" />
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="<center>出院人数</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="98">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>占全科出院人数</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="98">
                                            
                                        </ext:Column>
                                        <ext:Column Header="<center>占全院出院人数</center>" Sortable="true" ColumnID="Columns4" DataIndex="Columns4" 
                                            Align="center" Width="98">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>治愈人数</center>" Sortable="true" ColumnID="Columns5" DataIndex="Columns5"
                                            Align="center" Width="98">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        ...
                                        <ext:Column Header="<center>好转人数</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="98">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        <ext:Column Header="<center>无效人数</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="98">
                                        ...
                                        <ext:Column Header="<center>未治人数</center>" Sortable="true" ColumnID="Columns6" DataIndex="Columns6" Align="center" Width="98">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                        
                                        <ext:Column Header="<center>死亡人数</center>" Sortable="true" ColumnID="Columns7" DataIndex="Columns7"
                                            Align="center" Width="151">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                         <ext:Column Header="<center>其他结果人数</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
                                            Align="center" Width="151">
                                            <PrepareCommand Handler="" Args="grid,command,record,row,col,value" FormatHandler="False">
                                            </PrepareCommand>
                                        </ext:Column>
                                        
                                         <ext:Column Header="<center>有效率</center>" Sortable="true" ColumnID="Columns8" DataIndex="Columns8"
