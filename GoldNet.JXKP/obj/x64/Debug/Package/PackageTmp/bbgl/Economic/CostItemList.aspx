<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostItemList.aspx.cs" Inherits="GoldNet.JXKP.bbgl.Economic.CostItemList" %>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="<center>科室名称</center>" Sortable="true" ColumnID="Columns1" DataIndex="Columns1"
                                            Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>项目类别</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>发生日期</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>成本额</center>" Sortable="true" ColumnID="Columns4" DataIndex="Columns4"
                                            Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>操作者</center>" Sortable="true" ColumnID="Columns5" DataIndex="Columns5"
                                            Align="center" Width="116">
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
