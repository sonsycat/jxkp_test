<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckPersonBonusEdit.aspx.cs"
    Inherits="GoldNet.JXKP.CheckPersonBonusEdit" %>
                                ...
                                <Body>
                                    <ext:BorderLayout ID="BorderLayout1" runat="server">
                                        <Center>
                                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                                ...
                                                <TopBar>
                                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" Visible="true" AutoWidth="true">
                                                        <Items>
                                                            ...
                                                            <ext:ComboBox ID="cbbdept" runat="server" StoreID="SDept" DisplayField="DEPT_NAME"
                                                                ...
                                                                ItemSelector="div.search-item" MinChars="1" ListWidth="200" Editable="false"
                                                                Disabled="true">
                                                    ...
                                                    <tpl for=".">
                                                        <div class="search-item">
                                                            ...
                                                            <ext:TextField ID="staffname" runat="server" EmptyText="姓名">
                                                            </ext:TextField>
                                                ...
                                                <ColumnModel ID="ColumnModel22" runat="server" Enabled="false">
                                                    <Columns>
                                                        <ext:Column ColumnID="DEPTNAME" Header="核算科室" Width="100" DataIndex="DEPTNAME" MenuDisabled="true"
                                                            Align="Center">
                                                        </ext:Column>
                                                        ...
                                                        <ext:Column ColumnID="DAYS" Header="<div style='text-align:center;'>工作日数</div>" Width="100"
                                                            ...
                                                            <Editor>
                                                                <ext:NumberField runat="server" ID="nfdays" SelectOnFocus="true" DecimalPrecision="6"
                                                        ...
                                                        <ext:Column ColumnID="BONUSMODULUS" Header="<div style='text-align:center;'>科室自设系数</div>"
                                                            ...
                                                            <Editor>
                                                                <ext:NumberField runat="server" ID="nfbonusmodules" SelectOnFocus="true" DecimalPrecision="6">
                                                                </ext:NumberField>
                                                            </Editor>
                                                        </ext:Column>
                                                        <ext:Column ColumnID="PERSONSMODULUS" Header="<div style='text-align:center;'>院标准系数</div>"
                                                            ...
                                                            <Editor>
                                                                <ext:NumberField runat="server" ID="nfpersonsmodules" SelectOnFocus="true" DecimalPrecision="6">
                                                                </ext:NumberField>
                                                            </Editor>
                                                        </ext:Column>
                                                        <ext:Column ColumnID="SUBSIDYMODULUS" Header="<div style='text-align:center;'>其它系数</div>"
                                                            Width="100" DataIndex="SUBSIDYMODULUS" Align="Right" MenuDisabled="true">
                                                            <Editor>
                                                                <ext:NumberField runat="server" ID="nfsubsidymodules" SelectOnFocus="true" DecimalPrecision="6">
                                                                </ext:NumberField>
                                                            </Editor>
                                                        </ext:Column>
                                                        <ext:Column ColumnID="SUMMODULUS" Header="<div style='text-align:center;'>合计</div>"
                                                            Width="100" DataIndex="SUMMODULUS" Align="Right" MenuDisabled="true">
                                                        </ext:Column>
                                                    </Columns>
                                                </ColumnModel>
                                                <SelectionModel>
                                        ...
                                        <East Collapsible="True" Split="True" MinWidth="40" MaxWidth="248">
                                            <ext:Panel runat="server" ID="PanelEast" Width="248" Title="核算科室人员" Border="false">
                                                <TopBar>
                                                    <ext:Toolbar ID='asq' runat="server">
                                                        <Items>
                                                            <ext:ComboBox ID="ComboBox1" runat="server" StoreID="SDept" DisplayField="DEPT_NAME"
                                                                ValueField="DEPT_CODE" TypeAhead="false" LoadingText="Searching..." Width="150"
                                                                ItemSelector="div.search-item" MinChars="1" ListWidth="200" BlankText="科室选择">
