<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AverageBonusDaysAdd.aspx.cs"
    Inherits="GoldNet.JXKP.AverageBonusDaysAdd" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function addRecord(y,m,di,dn,sn,ib,d,bm,og) {
        ...
        function totalData(cell) {
            ...
            if (cell.column == 3) {
                ...
                TextField5.setValue('奖金系数合计：' + total);
            }
            else if (cell.column == 6) {
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:ComboBox runat="server" ID="cbbdept" StoreID="Store2" Width="100" DisplayField="DEPTNAME"
                                                ValueField="DEPTID" ReadOnly="true" BlankText="选择科室">
                                            </ext:ComboBox>
                                ...
                                <ColumnModel ID="ColumnModel22" runat="server" Enabled="false">
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="BONUSMODULUS" Header="<div style='text-align:center;'>岗位系数</div>"
                                            ...
                                            <Editor>
                                                <ext:NumberField runat="server" ID="nfbonusmodules" SelectOnFocus="true" DecimalPrecision="2">
                                                </ext:NumberField>
                                            </Editor>
                                        </ext:Column>
                                        <ext:Column ColumnID="OBLIGATION" Header="<div style='text-align:center;'>责任奖系数</div>"
                                            ...
                                            <Editor>
                                                <ext:NumberField runat="server" ID="nfobligation" SelectOnFocus="true" DecimalPrecision="2">
                                                </ext:NumberField>
                                            </Editor>
                                        </ext:Column>
                                    </Columns>
