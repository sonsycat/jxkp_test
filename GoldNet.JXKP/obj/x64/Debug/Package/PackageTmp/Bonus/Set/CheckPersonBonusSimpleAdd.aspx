<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckPersonBonusSimpleAdd.aspx.cs"
    Inherits="GoldNet.JXKP.Bonus.Set.CheckPersonBonusSimpleAdd" %>
    ...
    <div>
        <ext:FormPanel ID="FormPanel1" runat="server" Border="false" AutoScroll="false" ButtonAlign="Right"
            ...
            <Body>
                ...
                <ext:Anchor Horizontal="95%">
                    <ext:NumberField runat="server" ID="nfPERSONSMODULUS" CausesValidation="true" FieldLabel="人员系数"
                        Text="0.00" AllowBlank="false" SelectOnFocus="true" DecimalPrecision="4" StyleSpec="text-align:right">
                    </ext:NumberField>
                </ext:Anchor>
                <ext:Anchor Horizontal="95%">
                    <ext:NumberField runat="server" ID="nfSUBSIDYMODULUS" CausesValidation="true" FieldLabel="补贴系数"
                        Text="0.00" AllowBlank="false" SelectOnFocus="true" DecimalPrecision="4" StyleSpec="text-align:right">
                    </ext:NumberField>
                </ext:Anchor>
            </Body>
