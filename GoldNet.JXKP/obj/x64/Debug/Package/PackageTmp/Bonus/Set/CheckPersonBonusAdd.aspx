<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckPersonBonusAdd.aspx.cs"
    Inherits="GoldNet.JXKP.CheckPersonBonusAdd" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function addRecord(y,m,di,dn,sn,ib,d,bm,aa,bb) {

            var rowindex = GridPanel2.addRecord();
            var record = Store1.getAt(rowindex);
            record.data['YEARS'] = y;
            record.data['MONTHS'] = m;
            record.data['DEPTID'] = di;
            record.data['DEPTNAME'] = dn;
            record.data['STAFFNAME'] = sn;
            record.data['ISBONUS'] = ib;
            record.data['DAYS'] = d;
            record.data['BONUSMODULUS'] = bm;
            record.data['PERSONSMODULUS'] = aa;
            record.data['SUBSIDYMODULUS'] = bb;
                                    ...
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:Button ID="Btn_Del" Text="删除人员" Icon="Delete" runat="server" Disabled="true">
                                                <Listeners>
                                                    <Click Handler="#{GridPanel2}.deleteSelected();if (!#{GridPanel2}.hasSelection()) {#{Btn_Del}.disable();} RenderTotalData(#{GridPanel2}.store)" />
                                                </Listeners>
                                            </ext:Button>
