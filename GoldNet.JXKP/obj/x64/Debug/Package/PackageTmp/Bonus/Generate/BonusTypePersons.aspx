<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BonusTypePersons.aspx.cs" Inherits="GoldNet.JXKP.BonusTypePersons" %>
                                 ...
                                 <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0" >
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="personstype" runat="server" AllowBlank="true" EmptyText="请选择人员类别" Width="200"
                                            FieldLabel="人员类别选择">
                                            
                                        </ext:ComboBox>
                                            <ext:ToolbarSpacer ID="ToolbarSpacer2" runat="server" Width="20">
                                            </ext:ToolbarSpacer>
                                            <ext:Button ID="btn_Query" runat="server" Text="查询" Icon="FolderMagnify">
                                                 <AjaxEvents>
