<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPersons.aspx.cs" Inherits="GoldNet.JXKP.AddPersons" %>
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Button_EditSet" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:TextField ID="personsname" runat="server" Hidden="true">
                                            </ext:TextField>
                                            <ext:Button ID="Button5" runat="server" Text="单个添加" Icon="ApplicationAdd" Hidden="true">
                                                <AjaxEvents>
                                            ...
                                            <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" AutoExpandColumn="DEPT_NAME"
                                                ...
                                                <TopBar>
                                                    <ext:Toolbar ID="Toolbar2" runat="server">
                                                        <Items>
                                                            <ext:Label ID="role" runat="server" Text="当前科室：">
                                                            </ext:Label>
                                                            <ext:ComboBox ID="ComboBox_Role" runat="server" AllowBlank="false" EmptyText="请选择科室"
                                                                FieldLabel="科室选择">
                                                            </ext:ComboBox>
                                                        </Items>
                                                    </ext:Toolbar>
