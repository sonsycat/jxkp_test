<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qu_attendance.aspx.cs"
    Inherits="GoldNet.JXKP.Bonus.Input.qu_attendance" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="ZWTS">
                    </ext:RecordField>
                    <ext:RecordField Name="SUBSIDY">
                    </ext:RecordField>
                    <ext:RecordField Name="MONEYS">
                    </ext:RecordField>
                </Fields>
            </ext:JsonReader>
        </Reader>
                                ...
                                <Body>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="SReport" Border="true"
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:ExtColumn ColumnID="DATETIME" Header="<div style='text-align:center;'>时间</div>"
                                                    Width="120" DataIndex="DATETIME" MenuDisabled="true">
                                                </ext:ExtColumn>
                                                ...
                                                <ext:ExtColumn ColumnID="NAME" Header="<div style='text-align:center;'>姓名</div>"
                                                    Width="120" DataIndex="NAME" MenuDisabled="true" Align="left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="JOB" Header="<div style='text-align:center;'>职务</div>" Width="120"
                                                    DataIndex="JOB" MenuDisabled="true" Align="left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ZWTS" Header="<div style='text-align:center;'>在岗天数</div>"
                                                    Width="120" DataIndex="ZWTS" MenuDisabled="true" Align="Right">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="SUBSIDY" Header="<div style='text-align:center;'>职务标准</div>"
                                                    Width="120" DataIndex="SUBSIDY" MenuDisabled="true" Align="Right">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="MONEYS" Header="<div style='text-align:center;'>职务津贴</div>"
                                                    Width="120" DataIndex="MONEYS" MenuDisabled="true" Align="Right">
