<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherAward_Type_Edit.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.OtherAward_Type_Edit" %>
        ...
        <ext:FormLayout ID="FormLayout1" runat="server">
            ...
            <ext:Anchor>
                <ext:TextField ID="Text_CenterName" runat="server" DataIndex="centerame" MsgTarget="Side"
                    AllowBlank="false" FieldLabel="单项奖惩项目" Width="180" />
            </ext:Anchor>
