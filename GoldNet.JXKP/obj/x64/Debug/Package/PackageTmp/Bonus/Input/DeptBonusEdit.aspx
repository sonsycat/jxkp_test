<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptBonusEdit.aspx.cs"
    Inherits="GoldNet.JXKP.Bonus.Input.DeptBonusEdit" %>
...
<body>
    ...
    <div>
        <ext:FormPanel ID="FormPanel1" runat="server" Border="false" AutoScroll="false" ButtonAlign="Right"
            ...
            <Body>
                <ext:Resizable ID="Resizable3" runat="server" Element="taReason" Handles="South"
                    Wrap="true" Pinned="true" Height="96" MinHeight="60" Dynamic="true" />
                <ext:FormLayout ID="FormLayout1" runat="server" LabelWidth="80">
                    <ext:Anchor Horizontal="70%">
                        <ext:DateField runat="server" ID="dfInputDate" CausesValidation="true" FieldLabel="奖金时间"
                    ...
                    <ext:Anchor Horizontal="70%">
                        <ext:ComboBox ID="cbbdept" runat="server" StoreID="Store3" DisplayField="DEPT_NAME"
                            ...
                            PageSize="10" ItemSelector="div.search-item" MinChars="1" FieldLabel="发放科室" ListWidth="240"
                    ...
                    <ext:Anchor Horizontal="70%">
                        <ext:NumberField runat="server" ID="nfNumber" CausesValidation="true" FieldLabel="发放金额"
                            Text="0" AllowBlank="false" SelectOnFocus="true" DecimalPrecision="2" StyleSpec="text-align:right">
                        </ext:NumberField>
                    </ext:Anchor>
                    <ext:Anchor Horizontal="95%">
                        <ext:TextArea runat="server" ID="taReason" FieldLabel="说明" Height="80" />
                    </ext:Anchor>
                    <ext:Anchor Horizontal="70%">
