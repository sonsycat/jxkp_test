<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherAwardList.aspx.cs"
    Inherits="GoldNet.JXKP.OtherAwardList" %>
...
<body>
    ...
    <div>
                ...
                <ext:ColumnLayout ID="ColumnLayout1" runat="server" Split="true" FitHeight="true">
                    <Columns>
                        <ext:LayoutColumn ColumnWidth="1">
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:Button ID="Edit_Type" runat="server" Text="奖惩项目维护" Icon="FolderMagnify">
                                                <AjaxEvents>
                                                    <Click OnEvent="Edit_Type_Click">
                                                    </Click>
                                                </AjaxEvents>
                                            </ext:Button>
                            ...
                            ValueField="TYPEID"  Width="120"  FieldLabel="奖惩项目"    CausesValidation="true" AllowBlank="false">  
                            <AjaxEvents>
                            <Select OnEvent="Btn_Search_Click">
                                            ...
                                            <ext:Button ID="Button2" runat="server" Text="保存" Icon="ApplicationAdd">
                                            <AjaxEvents>
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        <ext:Column ColumnID="INPUTDATE" Header="奖惩时间" Width="200" DataIndex="INPUTDATE"
                                            MenuDisabled="true" Align="Center">
                                        </ext:Column>
                                        <ext:Column ColumnID="DEPTNAME" Header="奖惩科室" Width="200" DataIndex="DEPTNAME" MenuDisabled="true"
                                            Align="Center">
                                        </ext:Column>
                                        <ext:Column ColumnID="REASON" Header="<div style='text-align:center;'>奖惩原因</div>"
                                            Width="200" DataIndex="REASON" MenuDisabled="true" Align="Left">
                                        </ext:Column>
                                        <ext:Column ColumnID="MONEY" Header="<div style='text-align:center;'>奖惩金额</div>"
                                    ...
                                    <ext:Toolbar ID="Toolbar1" runat="server" Visible="false">
                                        <Items>
                                            ...
                                            <ext:TextField ID="txt_SearchTxt" runat="server" EmptyText="查找">
                                                <ToolTips>
                                                    <ext:ToolTip ID="ToolTip1" runat="server" Html="根据奖惩时间，奖惩科室，奖惩原因模糊查找">
                                                    </ext:ToolTip>
                                                </ToolTips>
                                            </ext:TextField>
        ...
        <ext:Window ID="edittype" runat="server" Icon="Group" Title="奖项项目维护" Width="400"
        ...
        <ext:Window ID="DetailWin" runat="server" Icon="Group" Title="其他奖项录入" Width="400"
            Height="400" AutoShow="false" Modal="true" CenterOnLoad="true" AutoScroll="true"
            ShowOnLoad="false" Resizable="false" StyleSpec="background-color:Transparent;"
            BodyStyle="background-color:Transparent;">
        </ext:Window>
       <%-- <ext:Window ID="Search" runat="server" Icon="Group" Title="其他奖项录入查询" Width="460"
            Height="400" AutoShow="false" Modal="true" CenterOnLoad="true" AutoScroll="true"
            ShowOnLoad="false" Resizable="false" StyleSpec="background-color:Transparent;"
            BodyStyle="background-color:Transparent;">
            <AjaxEvents>
