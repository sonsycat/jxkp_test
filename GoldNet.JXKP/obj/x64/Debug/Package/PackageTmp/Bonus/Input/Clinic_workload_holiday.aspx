<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clinic_workload_holiday.aspx.cs" Inherits="GoldNet.JXKP.Bonus.Input.Clinic_workload_holiday" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="VISIT_DEPT">
                    </ext:RecordField>
                    <ext:RecordField Name="DEPT_NAME">
                    </ext:RecordField>
                    <ext:RecordField Name="CLINIC_LABEL">
                    </ext:RecordField>
                    <ext:RecordField Name="CLINIC_TYPE">
                    </ext:RecordField>
                    <ext:RecordField Name="CON">
                    </ext:RecordField>
                </Fields>
            </ext:JsonReader>
        </Reader>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="SReport" Border="true"
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:ExtColumn ColumnID="CLINIC_LABEL" Header="<div style='text-align:center;'>号别</div>"
                                                    Width="120" DataIndex="CLINIC_LABEL" MenuDisabled="true" Align="left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="CLINIC_TYPE" Header="<div style='text-align:center;'>号类</div>" Width="120"
                                                    DataIndex="CLINIC_TYPE" MenuDisabled="true" Align="left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="CON" Header="<div style='text-align:center;'>数量</div>"
                                                    Width="120" DataIndex="CON" MenuDisabled="true" Align="Right">
                                                </ext:ExtColumn>
                                            </Columns>
                                        </ExtColumnModel>
                                        <SelectionModel>
