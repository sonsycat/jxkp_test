<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HospitalCostAccount.aspx.cs"
    Inherits="GoldNet.JXKP.HospitalCostAccount" %>
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:ExtColumn ColumnID="DEPT_NAME" Header="<div style='text-align:center;'>科室</div>"
                                                    Width="130" DataIndex="DEPT_NAME" MenuDisabled="true" Align="Left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="CREALINCOMES" Header="<div style='text-align:center;'>门诊</div>"
                                                    Width="100" DataIndex="CREALINCOMES" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="HREALINCOMES" Header="<div style='text-align:center;'>住院</div>"
                                                    Width="100" DataIndex="HREALINCOMES" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="FACACCOUNTINCOMES" Header="<div style='text-align:center;'>合计</div>"
                                                    Width="100" DataIndex="FACACCOUNTINCOMES" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="COSTS" Header="<div style='text-align:center;'>实际医疗成本</div>"
                                                    Width="100" DataIndex="COSTS" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="PROFIT" Header="<div style='text-align:center;'>实际医疗收益</div>"
                                                ...
                                                <ext:ExtColumn ColumnID="CVALATIONINCOMES" Header="<div style='text-align:center;'>门诊</div>"
                                                    Width="100" DataIndex="CVALATIONINCOMES" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="HVALATIONINCOMES" Header="<div style='text-align:center;'>住院</div>"
                                                    Width="100" DataIndex="HVALATIONINCOMES" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ARMACCOUNTINCOMES" Header="<div style='text-align:center;'>合计</div>"
                                                    Width="100" DataIndex="ARMACCOUNTINCOMES" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ARMYCOSTS" Header="<div style='text-align:center;'>计价医疗成本</div>"
                                            ...
                                            <HeadRows>
                                                <ext:ExtRows>
                                                    <Rows>
                                                        ...
                                                        <ext:ExtRow Header="实际医疗收入" ColSpan="3" Align="Center" />
                                                        <ext:ExtRow Header="" ColSpan="1" Align="Center" />
                                                        <ext:ExtRow Header="" ColSpan="1" Align="Center" />
                                                        <ext:ExtRow Header="计价医疗收入" ColSpan="3" Align="Center" />
                                                        <ext:ExtRow Header="" ColSpan="1" Align="Center" />
                                                    </Rows>
                                                </ext:ExtRows>
                                            </HeadRows>
