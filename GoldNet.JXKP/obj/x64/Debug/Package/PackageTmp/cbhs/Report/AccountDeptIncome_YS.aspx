<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountDeptIncome_YS.aspx.cs" Inherits="GoldNet.JXKP.AccountDeptIncome_YS" %>
                                    ...
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="incomestype" runat="server" ReadOnly="true" ForceSelection="true"
                                                ...
                                                <Items>
                                                    <ext:ListItem Text="开单" Value="1" />
                                                    <ext:ListItem Text="执行" Value="0" />
                                                </Items>
                                            </ext:ComboBox>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="SReport" Border="true"
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:ExtColumn ColumnID="HJ" Header="<div style='text-align:center;'>总收入</div>"
