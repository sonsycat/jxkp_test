<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YearIncomeCompare.aspx.cs" Inherits="GoldNet.JXKP.YearIncomeCompare" %>
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0" >
                                        <Items>
                                            ...
                                            <ext:Label ID="lmonth" runat="server" Text="到：">
                                            </ext:Label>
