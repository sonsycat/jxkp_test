<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HospitalOrderRealIncome.aspx.cs" Inherits="GoldNet.JXKP.HospitalOrderRealIncome" %>
...
<body>
    ...
    <div>
        <ext:ViewPort ID="ViewPort1" runat="server" AutoHeight="false" AutoWidth="false">
            <Body>
                <ext:ColumnLayout ID="ColumnLayout1" runat="server" Split="true" FitHeight="true">
                    <Columns>
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:Panel runat="server" ID="p11" AutoScroll="true" Border="false" AutoHeight="false" AutoWidth="false">
                                <TopBar>
                                ...
                                <Body>
                                   ...
                                   <ext:ExtGridPanel ID="GridPanel_Show" runat="server"  Border="true" StoreID="SReport"
