<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KSHSXX_DYKSQK.aspx.cs"
    Inherits="GoldNet.JXKP.cbhs.Report.KSHSXX_DYKSQK" %>
            ...
            <Reader>
                <ext:JsonReader ReaderID="DEPT_CODE">
                    <Fields>
                        ...
                        <ext:RecordField Name="SJZCBZCC" />
                        <ext:RecordField Name="JJZCBZCC" />
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" BodyBorder="false" AutoScroll="true"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="核算单位" Width="130" ColumnID="DEPT_NAME" DataIndex="DEPT_NAME">
                                        </ext:Column>
                                        ...
                                        <ext:Column Header="实收与总收比" Width="90" ColumnID="SSZSB" DataIndex="SSZSB">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <ext:Column Header="计价与总收比" Width="90" ColumnID="JJZSB" DataIndex="JJZSB">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        ...
                                        <ext:Column Header="总支出" Width="90" ColumnID="ZCZE" DataIndex="ZCZE">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <ext:Column Header="实际支出比总支出" Width="90" ColumnID="SJZCBZCC" DataIndex="SJZCBZCC">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <ext:Column Header="计价支出比总支出" Width="90" ColumnID="JJZCBZCC" DataIndex="JJZCBZCC">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        ...
                                        <ext:Column Header="支出与总收比" Width="90" ColumnID="ZCZSB" DataIndex="ZCZSB">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
