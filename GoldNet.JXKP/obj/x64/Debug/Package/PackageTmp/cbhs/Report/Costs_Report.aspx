<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Costs_Report.aspx.cs" Inherits="GoldNet.JXKP.Costs_Report" %>
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="costtype" runat="server" AllowBlank="true" ForceSelection="true"
                                                SelectOnFocus="true" Width="100">
                                                <Items>
                                                    <ext:ListItem Text="实际" Value="1" />
