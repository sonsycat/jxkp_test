<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Incomes_Report.aspx.cs" Inherits="GoldNet.JXKP.Incomes_Report" %>
                                 ...
                                 <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0" >
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbbType" runat="server" ReadOnly="true" ForceSelection="true" SelectOnFocus="true" Width="100">
                                               <Items>
                                            ...
                                            <ext:ComboBox ID="costtype" runat="server" ReadOnly="true" ForceSelection="true" SelectOnFocus="true" Width="100" SelectedIndex="0">
                                                <Items>
