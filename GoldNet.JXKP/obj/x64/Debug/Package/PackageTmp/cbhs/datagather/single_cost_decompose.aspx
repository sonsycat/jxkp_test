<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="single_cost_decompose.aspx.cs"
    Inherits="GoldNet.JXKP.cbhs.datagather.single_cost_decompose" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        {
            padding-right: 0px; /*显示竖线*/
            border-right: 1px solid #eceff6; /*显示底线*/
                                    ...
                                    <ext:Toolbar ID="Toolbar_fjsr" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:Button ID="Button_save" runat="server" Text="保存" Icon="Disk">
                                                <Listeners>
                                                    <Click Handler="#{GridPanel1}.submitData();"></Click>
                                                </Listeners>
                                            </ext:Button>
                                            ...
                                            <ext:ComboBox ID="PROG_ITEM" runat="server" Width="100" AllowBlank="true" EmptyText="请选择...">
                                                <%--<AjaxEvents>
                                                    <Select OnEvent="Prog_SelectOnChange">
                                                        <EventMask Msg='载入中...' ShowMask="true" />
                                                    </Select>
                                                </AjaxEvents>--%>
                                            </ext:ComboBox>
                                            ...
                                            <ext:Button ID="Button_break" runat="server" Text="成本分解" Icon="ArrowOut">
                                                <AjaxEvents>
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column ColumnID="DEPT_CODE" Header="<div style='text-align:center;'>科室代码</div>"
                                            Width="130" Align="left" Sortable="false" Hidden="true" DataIndex="DEPT_CODE"
                                            MenuDisabled="true" />
