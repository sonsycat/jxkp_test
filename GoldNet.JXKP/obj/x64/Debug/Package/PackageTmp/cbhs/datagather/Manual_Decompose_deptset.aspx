<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manual_Decompose_deptset.aspx.cs" Inherits="GoldNet.JXKP.cbhs.datagather.Manual_Decompose_deptset" %>
                                            ...
                                            <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" AutoExpandColumn="DEPT_NAME"
                                                ...
                                                <TopBar>
                                                    <ext:Toolbar ID="Toolbar2" runat="server">
                                                        <Items>
                                                            <ext:Label ID="role" runat="server" Text="已选科室">
                                                            </ext:Label>
                                                ...
                                                <ColumnModel ID="ColumnModel2" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column ColumnID="ratio" Header="分摊数" Width="100" Align="right" Sortable="true"
                                                            DataIndex="RATIO" MenuDisabled="true">
                                                            <Editor>
                                                                <ext:NumberField ID="nfpercent" runat="server" SelectOnFocus="true" DecimalPrecision="4"
                                                                   >
                                                                </ext:NumberField>
                                                            </Editor>
                                                        </ext:Column>
