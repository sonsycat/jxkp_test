<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="incom_other_dept_set.aspx.cs" Inherits="GoldNet.JXKP.cbhs.cbhsdict.incom_other_dept_set" %>
                                            ...
                                            <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" AutoExpandColumn="DEPT_NAME"
                                                ...
                                                <TopBar>
                                                    <ext:Toolbar ID="Toolbar2" runat="server">
                                                        <Items>
                                                            <ext:ComboBox ID="ComboBox1" runat="server" AllowBlank="false" Width="100"> 
                                                                <Items>
                                                ...
                                                <ColumnModel ID="ColumnModel2" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column ColumnID="ratio" Header="分摊比例" Width="60" Align="right" Sortable="true"
