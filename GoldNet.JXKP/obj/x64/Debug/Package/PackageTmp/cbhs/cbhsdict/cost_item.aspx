<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cost_item.aspx.cs" Inherits="GoldNet.JXKP.cbhs.cbhsdict.cost_item" %>
            ...
            <Reader>
                <ext:JsonReader ReaderID="ITEM_CODE">
                    <Fields>
                        ...
                        <ext:RecordField Name="COST_PROPERTY" />
                        <ext:RecordField Name="ALLOT_FOR_JD" />
                        <ext:RecordField Name="ALLOT_FOR_JC" />
                        <ext:RecordField Name="ALLOT_FOR_RY" />
                        <ext:RecordField Name="GETTYPE" />
                        <ext:RecordField Name="ITEM_POWER" />
                        <ext:RecordField Name="ACCOUNT_TYPE" />
                        <ext:RecordField Name="COMPUTE_PER" />
                        <ext:RecordField Name="COST_DIRECT" />
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
            ...
            <Body>
                <ext:BorderLayout ID="BorderLayout2" runat="server">
                    <North>
                        <ext:Toolbar ID="Toolbar1" runat="server" Visible="true" AutoWidth="true">
                            <Items>
                                ...
                                <ext:Button ID="btn_Add" runat="server" Text="添加" Icon="Add" Disabled="true">
                                    <AjaxEvents>
                    ...
                    <West Collapsible="false" Split="false" CollapseMode="Mini">
                        <ext:Panel ID="Panel2" runat="server" Width="175" BodyBorder="false"
                         ...
                         <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <SelectionModel>
                                    <ext:RowSelectionModel ID="RowSelectionModel1" runat="server" SingleSelect="true">
                                        <Listeners>
                                            <RowSelect Handler="#{btn_Add}.enable();#{btn_Modify}.enable();#{btn_Delete}.enable()" />
                                            <RowDeselect Handler="if (!#{GridPanel1}.hasSelection()) {#{btn_Modify}.disable();#{btn_Delete}.disable();#{btn_Add}.disable()}" />
                                        </Listeners>
