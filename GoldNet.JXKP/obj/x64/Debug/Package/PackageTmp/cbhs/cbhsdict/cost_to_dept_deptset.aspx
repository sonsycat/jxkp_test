<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cost_to_dept_deptset.aspx.cs" Inherits="GoldNet.JXKP.cbhs.cbhsdict.cost_to_dept_deptset" %>
                                            ...
                                            <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" AutoExpandColumn="DEPT_NAME"
                                                ...
                                                <ColumnModel ID="ColumnModel2" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column ColumnID="ratio" Header="分摊系数" Width="60" Align="right" Sortable="true"
