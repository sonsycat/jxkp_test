        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Border="false" MonitorValid="true"
            ...
            <Body>
                <ext:FormLayout ID="FormLayout1" runat="server" LabelWidth="80" StyleSpec="margin:10px">
                    <ext:Anchor>
                        <ext:MultiField ID="MultiField7" runat="server" FieldLabel="调整表">
                            <Fields>
                                <ext:ComboBox ID="INCOME_NAME" runat="server" EmptyText="请选表..." AllowBlank="false"
                                    Width="220">
                                    <Items>
                                        <ext:ListItem Text="收入:门诊表" Value="0" />
                                        <ext:ListItem Text="收入:住院表" Value="1" />
                                        <ext:ListItem Text="成本:提取成本" Value="2" />
                                    </Items>
                                </ext:ComboBox>
