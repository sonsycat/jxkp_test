<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xyhs_cost_income_set.aspx.cs" Inherits="GoldNet.JXKP.cbhs.xyhs.xyhs_cost_income_set" %>
                        ...
                        <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>          
                                    ...
                                    <ext:Column ColumnID="COST_CODE" Header="成本代码" Width="100" Align="left" Sortable="true"
                                        DataIndex="COST_CODE" MenuDisabled="true" />
                                    <ext:Column ColumnID="COST_NAME" Header="成本名称" Width="120" Align="left" Sortable="true"
