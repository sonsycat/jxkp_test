<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dept_Cost_Decompose.aspx.cs" Inherits="GoldNet.JXKP.cbhs.xyhs.Operation.Dept_Cost_Decompose" %>
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar1" runat="server">
                                        <Items>
                                            ...
                                            <ext:Button ID="Button_create" runat="server" Text="成本三级分摊" Icon="ArrowOut">
                                                <AjaxEvents>
                                                    <Click OnEvent="Button_create_click" Timeout="999999">
                                                        <Confirmation ConfirmRequest="true" Title="系统提示" Message="将进行成本三级分摊摊,<br/>是否继续?" />
                                                        <ExtraParams>
                                                        </ExtraParams>
                                                        <EventMask Msg="载入中..." ShowMask="true" />
                                                    </Click>
