<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appor_prog_dict.aspx.cs" Inherits="GoldNet.JXKP.cbhs.xyhs.xyhsdict.appor_prog_dict" %>
...
<body>
   ...
   <ext:Store ID="Store1" runat="server" AutoLoad="true"  GroupField="APPORTION_NAME"  OnRefreshData="Store_RefreshData">
        <Reader>
                    ...
                    <ext:LayoutColumn ColumnWidth="1">
                        <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>          
                                    <ext:Column ColumnID="PROG_CODE" Header="<div style='text-align:center;'>方案代码</div>" Width="100" Align="left" Sortable="true"
                                        DataIndex="PROG_CODE" MenuDisabled="true" />  
                                    <ext:Column ColumnID="PROG_NAME" Header="<div style='text-align:center;'>方案名称</div>" Width="100" Align="left" Sortable="true"
                                    ...
                                    <ext:Column ColumnID="INPUT_CODE" Header="<div style='text-align:center;'>输入码</div>" Width="100" Align="left" Sortable="true"
                                        DataIndex="INPUT_CODE" MenuDisabled="true" />
                                    <ext:Column ColumnID="GUIDE_NAME" Header="<div style='text-align:center;'>指标</div>" Width="200"  DataIndex="GUIDE_NAME" Align="Left"
                                    ...
                                    <ext:CommandColumn Width="80" Align="Center" Header="<div style='text-align:center;'>选择项目</div>" Hidden="true">
                                        <Commands>
    ...
    <ext:Window ID="DetailWin" runat="server" Icon="Group" Title="成本分摊方案设置" Width="330"
            ...
            ShowOnLoad="false" Resizable="false" StyleSpec="background-color:Transparent;" BodyStyle="background-color:Transparent;">
    </ext:Window>
    <ext:Window ID="DictWin" runat="server" Icon="Group" Title="成本比例设置" Width="300" Height="300" Border="false" 
        AutoShow="false" Modal="true" CenterOnLoad="true" ShowOnLoad="false"
        Resizable="false" StyleSpec="background-color:Transparent;" BodyStyle="background-color:Transparent;">
        <Body>
            <ext:PropertyGrid ID="PropertyGrid1" runat="server"   AutoWidth="true"  AutoScroll="true" Height="270" >
                <Source>
                </Source>                  
                <Buttons>
    ...
    <ext:Window ID="DefaultDeptWin" runat="server" Icon="Group" Title="适用科室设置" Width="260"
        ...
        <Body>
            <ext:Panel ID="Panel1" runat="server" Border="false">
                <Body>
                    <ext:TreePanel runat="server" ID="DeptTreePanel" BodyBorder="false" AutoWidth="true" Height="350"
                        ...
                        <BottomBar>
                            <ext:Toolbar ID="Toolbar22" runat="server" >
                                <Items>
                                    <ext:ToolbarFill ID="ToolbarFill11" runat="server"></ext:ToolbarFill>
