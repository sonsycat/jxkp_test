<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appor_prog_sqlexpress.aspx.cs"
    Inherits="GoldNet.JXKP.cbhs.xyhs.xyhsdict.appor_prog_sqlexpress" %>
...
<body>
                    ...
                    <ext:LayoutColumn ColumnWidth="1">
                        <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    <ext:Column ColumnID="PROG_ITEM" Header="代码" Width="100" Align="left" Sortable="true"
                                        DataIndex="PROG_ITEM" MenuDisabled="true" />
                                    <ext:Column ColumnID="PROG_NAME" Header="名称" Width="100" Align="left" Sortable="true"
                                        DataIndex="PROG_NAME" MenuDisabled="true" />
                                    <ext:Column ColumnID="PROG_SQL" Header="SQL" Width="200" Align="left" Sortable="true"
                                        DataIndex="PROG_SQL" MenuDisabled="true" />
                                    <ext:Column ColumnID="APPORTION_CODE" Header="方案字典" Width="100" Align="left" Sortable="true"
                                        DataIndex="APPORTION_CODE" MenuDisabled="true" />
                                    <ext:Column ColumnID="PROG_MEMO" Header="备注" Width="100" Align="left" Sortable="true"
                                        DataIndex="PROG_MEMO" MenuDisabled="true" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
    ...
    <ext:Window ID="DetailWin" runat="server" Icon="Group" Title="成本分摊比例字典设置" Width="400"
