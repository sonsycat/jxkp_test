<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DirectCureAnalyse.aspx.cs"
    Inherits="GoldNet.JXKP.cbhs.xyhs.Report.DirectCureAnalyse" %>
                            ...
                            <ext:Panel runat="server" ID="p11" AutoScroll="true" Border="false">
                                ...
                                <Body>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="SReport" Border="true"
                                        ...
                                        <Listeners>
                                            <BeforeRender Handler="Ext.EventManager.onWindowResize(function(){ if(Ext.getBody().getViewSize().width>850){this.setWidth( Ext.getBody().getViewSize().width -5);}; this.setHeight( Ext.getBody().getViewSize().height -100); }, this);" />
                                            <Render Handler="if(Ext.getBody().getViewSize().width>850){this.setWidth( Ext.getBody().getViewSize().width -5);}; this.setHeight( Ext.getBody().getViewSize().height -100);" />
                                        </Listeners>
