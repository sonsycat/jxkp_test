<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetReportType.aspx.cs"    Inherits="GoldNet.JXKP.GuideLook.SetReportType" %>
...
<body>
    ...
    <div>
        ...
        <ext:KeyNav runat="server" Target="#{TreeCtrl}" > 
