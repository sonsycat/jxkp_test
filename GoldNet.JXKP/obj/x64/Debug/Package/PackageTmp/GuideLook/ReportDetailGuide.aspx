<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportDetailGuide.aspx.cs"
    Inherits="GoldNet.JXKP.GuideLook.ReportDetailGuide" %>
                ...
                <ext:BorderLayout ID="BorderLayout2" runat="server">
                    <Center>
                        <ext:GridPanel ID="GridPanel1" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                            Height="480" Width="600" AutoScroll="true">
