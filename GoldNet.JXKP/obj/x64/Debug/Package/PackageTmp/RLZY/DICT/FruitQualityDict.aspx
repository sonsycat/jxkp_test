<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FruitQualityDict.aspx.cs" Inherits="GoldNet.JXKP.RLZY.DICT.FruitQualityDict" %>
                                            ...
                                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column Header="成果性质" Width="150" Align="Center" Sortable="false" MenuDisabled="true"
