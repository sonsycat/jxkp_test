<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnGuardDays.aspx.cs" Inherits="GoldNet.JXKP.RLZY.BaseInfoManager.OnGuardDays" %>
                ...
                <ext:ColumnLayout ID="ColumnLayout3" runat="server" Split="true" FitHeight="true">
                    <Columns>
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel_Show" runat="server" Border="false" StoreID="Store1" StripeRows="true"
