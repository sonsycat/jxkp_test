<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Guide_SQLExpress.aspx.cs"
    Inherits="GoldNet.JXKP.jxkh.Guide_SQLExpress" %>
...
<body>
                        ...
                        <ext:Panel runat="server" Border="false" BodyStyle="background-color:transparent">
                            <TopBar>
                                <ext:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <ext:Label ID="Label7" runat="server" Text="指标数据 从月份:">
                                        </ext:Label>
                            ...
                            <Body>
                                <ext:FormPanel ID="FormPanel1" runat="server" Border="false" AutoScroll="true" Height="510"
                                    Width="530" ButtonAlign="Right" BodyStyle="background-color:transparent">
                                    <Body>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td>
                                                                        <ext:TextField ID="GuideCodeTxt" runat="server" ReadOnly="true" Width="150" />
                                                                    </td>
                                                                    <td style="padding-left: 2px; padding-bottom: 2px;">
                                                                        <ext:ComboBox ID="OrganComb" runat="server" Width="40" ListWidth="50" Disabled="true" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                        ...
                                        <ext:FieldSet ID="fieldset5" runat="server" Title="单月份指标SQL" Collapsible="true" Collapsed="false"
                                            StyleSpec="margin:2px" Width="510" BodyStyle="background-color:Transparent;">
                                            <Body>
                                                <ext:TextArea ID="GuideSQLTxt" runat="server" Width="482" MaxLength="3800" Height="120"
                                                    StyleSpec="margin:2px" />
                                                <ext:Resizable ID="Resizable1" runat="server" Element="GuideSQLTxt" Handles="South"
                                                    Wrap="true" Pinned="true" Width="482" Height="120" MinWidth="200" MinHeight="60"
                                                    Dynamic="true" />
                                            </Body>
                                        </ext:FieldSet>
                                        <ext:FieldSet ID="fieldset2" runat="server" Title="统计区间指标SQL" Collapsible="true"
                                            Collapsed="false" StyleSpec="margin:2px" Width="510" BodyStyle="background-color:Transparent;">
                                            <Body>
                                                <ext:TextArea ID="GuideSQLSumTxt" runat="server" Width="482" MaxLength="3800" Height="120"
                                                    StyleSpec="margin:2px" />
                                                <ext:Resizable ID="Resizable2" runat="server" Element="GuideSQLSumTxt" Handles="South"
                                                    Wrap="true" Pinned="true" Width="482" Height="120" MinWidth="200" MinHeight="60"
                                                    Dynamic="true" />
                                            </Body>
                                        </ext:FieldSet>
                                        <ext:FieldSet ID="fieldset3" runat="server" Title="指标明细数据SQL" Collapsible="true"
                                            Collapsed="true" StyleSpec="margin:2px" Width="510" BodyStyle="background-color:Transparent;">
                                            <Body>
                                                <ext:TextArea ID="GuideSQLDetailTxt" runat="server" Width="482" MaxLength="3800"
                                                    Height="120" StyleSpec="margin:2px" />
                                                <ext:Resizable ID="Resizable3" runat="server" Element="GuideSQLDetailTxt" Handles="South"
                                                    Wrap="true" Pinned="true" Width="482" Height="120" MinWidth="200" MinHeight="60"
                                                    Dynamic="true" />
                                            </Body>
                                        </ext:FieldSet>
    ...
    <ext:Window ID="GridWin" runat="server" Icon="Zoom" Title="数据预览" Width="460" Closable="true"
        CloseAction="Hide" Maximizable="true" Height="420" AutoShow="false" Modal="true"
