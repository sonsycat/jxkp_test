<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Assess_Result.aspx.cs"
    Inherits="GoldNet.JXKP.jxkh.Assess_Result" %>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column Header="所属岗位" Width="120" ColumnID="STATION_NAME" DataIndex="STATION_NAME"
                                        MenuDisabled="true" />
                                    <ext:Column Header="姓名" Width="78" ColumnID="USER_NAME" DataIndex="USER_NAME" MenuDisabled="true">
                                        <Commands>
