<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dept_Appraisal.aspx.cs"
    Inherits="GoldNet.JXKP.jxkh.Dept_Appraisal" %>
                                    ...
                                    <Items>
                                        ...
                                        <ext:ComboBox runat="server" ID="Comb_App" SelectedIndex="0" Width="88">
                                            <Items>
                                                ...
                                                <ext:ListItem Text="加权平均法" Value="RSR" />
                                            </Items>
                                        </ext:ComboBox>
                                        <ext:ToolbarSeparator ID="ToolbarSeparator4" runat="server">
                                        </ext:ToolbarSeparator>
                                        <ext:Button ID="Btn_SelectDept" runat="server" Icon="VcardAdd" Text="选择科室">
                                            <AjaxEvents>
                                                <Click OnEvent="Btn_SelectDept_Click">
                                        ...
                                        <ext:Button ID="Btn_Eval" runat="server" Icon="DatabaseGo" Disabled="true" Text="开始评价">
                                            <AjaxEvents>
                                                <Click OnEvent="Btn_Eval_Click" Timeout="9000000">
                                ...
                                <ext:TableLayout ID="TableLayout1" runat="server">
                                    <ext:Cell>
                                        <ext:Panel ID="Panel1" runat="server" Border="false" ButtonAlign="Left" Width="320"
                                            Height="400">
                                            <Body>
                                                <ext:MultiSelect ID="SelectorLeft" runat="server" Legend="已选择科室" Height="350" AutoWidth="true"
                                                    KeepSelectionOnClick="WithCtrlKey" StyleSpec="margin:5px;">
                                                </ext:MultiSelect>
                                            </Body>
                                            <Buttons>
                                                <ext:Button runat="server" Text="删除选中科室" ID="Btn_ClearDept" Icon="VcardDelete">
                                                    <Listeners>
