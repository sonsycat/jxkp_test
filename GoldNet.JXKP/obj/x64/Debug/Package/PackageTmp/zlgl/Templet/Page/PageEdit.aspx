<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageEdit.aspx.cs" Inherits="GoldNet.JXKP.zlgl.Templet.Page.PageEdit" %>
            ...
            <Body>
                ...
                StyleSpec="background-color:transparent" BodyStyle="background-color:transparent">
                    <Body>
                        ...
                        <asp:CheckBox ID="qualityedit" runat="server" Text="是否解决" Visible="false"></asp:CheckBox>
                    </Body>
                </ext:Panel>
            </Body>
        </ext:FormPanel>
