<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualitySearchByGuide.aspx.cs" Inherits="GoldNet.JXKP.zlgl.SysManage.QualitySearchByGuide" %>
...
<body>
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_guidetype" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="stardate" runat="server" AllowBlank="false" StoreID="Store3" Width="100" DisplayField="DATEDESC"
                                            ValueField="ID" ReadOnly="true" EmptyText="开始时间">
                                            </ext:ComboBox>
                                            <ext:ComboBox ID="enddate" runat="server" AllowBlank="false" StoreID="Store3" Width="100" DisplayField="DATEDESC"
                                            ValueField="ID" ReadOnly="true" EmptyText="结束时间">
                                            </ext:ComboBox>
    ...
    <ext:Window ID="guideDetail" runat="server" Icon="Group" Title="科室分项得分" Width="800" Height="500" AutoShow="false" Modal="true" CenterOnLoad="true" AutoScroll="true"
        ShowOnLoad="false" Resizable="true" StyleSpec="background-color:Transparent;" BodyStyle="background-color:Transparent;">
    </ext:Window>
     <ext:Window ID="BuideWin" runat="server" Icon="Add" Title="生成质量数据" Width="345"
            Height="180"  AutoShow="false" Modal="true"  CenterOnLoad="true" AutoScroll="false" ShowOnLoad="false" Closable="false" Resizable="false" StyleSpec="background-color:Transparent;" BodyStyle="background-color:Transparent;" CloseAction="Hide">
  </ext:Window>
    </form>
</body>
</html>
