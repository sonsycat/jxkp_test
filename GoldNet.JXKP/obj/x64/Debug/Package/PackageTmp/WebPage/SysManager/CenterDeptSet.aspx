<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CenterDeptSet.aspx.cs"
    Inherits="GoldNet.JXKP.WebPage.SysManager.CenterDeptSet" %>
...
<form id="form2" runat="server" style="background-color: Transparent">
    ...
    <Body>
        <ext:FormPanel ID="FormPanel1" runat="server" Border="false" AutoScroll="true"  Width="200" 
            ButtonAlign="Right" StyleSpec="background-color:transparent" BodyStyle="background-color:transparent">
            <Listeners>
                <Render Handler="SelectorLayout();" />
            </Listeners>
            <Body>
                        ...
                        <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" AutoExpandColumn="DEPT_NAME"
                            ...
                            <TopBar>
                                <ext:Toolbar ID="Toolbar2" runat="server">
                                    <Items>
                                        <ext:Label ID="role" runat="server" Text="专科中心：">
                                        </ext:Label>
                                        <ext:ComboBox ID="ComboBox_Center" runat="server" AllowBlank="false" EmptyText="请选择专科中心"
                                            FieldLabel="专科中心选择">
                                            <AjaxEvents>
                                                <Select OnEvent="SelectedCenter">
                                                    <EventMask ShowMask="true" />
                                                </Select>
                                            </AjaxEvents>
                                        </ext:ComboBox>
