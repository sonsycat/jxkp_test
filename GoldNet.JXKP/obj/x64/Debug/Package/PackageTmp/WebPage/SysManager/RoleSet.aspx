<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleSet.aspx.cs" Inherits="GoldNet.JXKP.WebPage.SysManager.RoleSet" %>
...
<body>
 <ext:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <Reader>
        <ext:JsonReader ReaderID="FUNCTION_ID">
            <Fields>
     ...
     <Columns>
      <ext:LayoutColumn ColumnWidth="1">
            ...
            <ext:LayoutColumn ColumnWidth="0.5">
                <ext:GridPanel runat="server" ID="GridPanel1" EnableDragDrop="false" AutoExpandColumn="FUNCTION_NAME"
                    StoreID="Store1">
                    <TopBar>
                        <ext:Toolbar ID="Toolbar2" runat="server">
                            <Items>
                                <ext:Label ID="func" runat="server" Text="模块：" Width="40">
                                </ext:Label>
                                <ext:ComboBox ID="Combo_FuncType" runat="server" AllowBlank="true" EmptyText="请选择模块"
                                    FieldLabel="模块选择">
                                    <AjaxEvents>
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            <ext:Column ColumnID="functionid" Header="id" DataIndex="FUNCTION_ID" Hidden="true" />
                        </Columns>
                        <Columns>
                            <ext:Column ColumnID="function" Header="功能" DataIndex="FUNCTION_NAME" Sortable="true" />
                        </Columns>
                    </ColumnModel>
                    <SelectionModel>
                    ...
                    <Plugins>
                        <ext:GridFilters ID="GridFilters1" runat="server" Local="true">
                            <Filters>
                                <ext:StringFilter DataIndex="FUNCTION_NAME" />
                            </Filters>
                        </ext:GridFilters>
                    </Plugins>
                    <Listeners>
            ...
            <ext:LayoutColumn ColumnWidth="0.5">
                <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" AutoExpandColumn="FUNCTION_NAME"
                    StoreID="Store2">
                    <TopBar>
                    ...
                    <ColumnModel ID="ColumnModel2" runat="server">
                        <Columns>
                            <ext:Column ColumnID="functionid" Header="id" DataIndex="FUNCTION_ID" Hidden="true" />
                            <ext:Column ColumnID="functionselected" Header="选中功能" DataIndex="FUNCTION_NAME" Sortable="true" />
                            <ext:CheckColumn ColumnID="checkedit" Header="编辑" DataIndex="EDIT" Editable="true"
                                Width="40" Align="Center">
                            </ext:CheckColumn>
                            <ext:CheckColumn ColumnID="checkpass" Header="审核(其它)" DataIndex="PASS" Editable="true"
