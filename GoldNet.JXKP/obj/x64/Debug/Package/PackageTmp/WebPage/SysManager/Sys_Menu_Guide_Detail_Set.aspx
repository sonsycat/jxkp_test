<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_Menu_Guide_Detail_Set.aspx.cs" Inherits="GoldNet.JXKP.WebPage.SysManager.Sys_Menu_Guide_Detail_Set" %>
...
<body>
    ...
    <div>
        <ext:Panel ID="Panel1" runat="server" Border="false" Header="false" AutoShow="false"
            ...
            <Body>
                <ext:Panel ID="SFM_DefineDetailsWindow" runat="server" Height="350" Width="760" Border="false"  BodyStyle="background-color:transparent">
                    <TopBar>
                        <ext:Toolbar runat="server" ID="ctl155" >
                            <Items>
                                ...
                                <ext:ToolbarSeparator ID="ToolbarSeparator1" runat="server">
                                 ...
                                 <ext:ToolbarFill ID="ToolbarFill1" Enabled="true" runat ="server"></ext:ToolbarFill>
                                <ext:Label runat="server" Text="选择指标：" ID="Label1">
                                </ext:Label>
                                <ext:ComboBox ID="comguide" runat="server" StoreID="Store3" DisplayField="GUIDE_NAME"
                            ValueField="GUIDE_CODE" Width="120"   CausesValidation="true" AllowBlank="false" ReadOnly="true">
                            <AjaxEvents>
                                        <Select OnEvent="Selectedguide">
                                            <EventMask ShowMask="true" />
                                        </Select>
                                    </AjaxEvents>
                        </ext:ComboBox>
                         <ext:Label runat="server" Text="是否求和：" ID="Label3">
                                </ext:Label>
                                 <ext:ComboBox ID="accounttype" runat="server" StoreID="Store4" DisplayField="TYPES"
                            ValueField="ID" Width="70"  CausesValidation="true" AllowBlank="false" ReadOnly="true">
                        </ext:ComboBox>
                               
                                 <ext:Button ID="Button6" runat="server" Icon="DatabaseGo" Text="保存">
                                    <AjaxEvents>
