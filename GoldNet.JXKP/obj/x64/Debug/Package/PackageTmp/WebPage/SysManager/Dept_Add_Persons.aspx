<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dept_Add_Persons.aspx.cs" Inherits="GoldNet.JXKP.WebPage.SysManager.Dept_Add_Persons" %>
                                ...
                                <Body>
                                    <ext:ColumnLayout ID="ColumnLayout1" runat="server" FitHeight="true">
                                        <ext:LayoutColumn ColumnWidth="0.5">
                                            <ext:GridPanel runat="server" ID="GridPanel1" EnableDragDrop="false" 
                                                StoreID="Store1">
                                                <TopBar>
                                                    <ext:Toolbar ID="Toolbar1" runat="server">
                                                        <Items>
                                                            <ext:Label ID="func" runat="server" Text="HIS科室：" Width="40">
                                                            </ext:Label>
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        <ext:Column ColumnID="userid" Header="人员编号" DataIndex="USER_ID" Sortable="true" />
                                                    </Columns>
                                                ...
                                                <BottomBar>
                                                    ...
                                                    <ext:StatusBar ID="StatusBar2" runat="server" 
                                                        ...
                                                        <Items>
                                                        <ext:Label ID="label1" runat ="server" Text="人员查找："></ext:Label>
                                                            <ext:TextField ID="txt_SearchTxt" runat="server" EmptyText="查找人员">
                                                                <ToolTips>
                                                                    <ext:ToolTip ID="ToolTip5" runat="server" Html="根据人员id、姓名查找">
                                                                    </ext:ToolTip>
                                                                </ToolTips>
                                                            </ext:TextField>
                                        ...
                                        <ext:LayoutColumn ColumnWidth="0.5">
                                            <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" 
                                                StoreID="Store2">
                                                <TopBar>
                                                    <ext:Toolbar ID="Toolbar2" runat="server">
                                                        <Items>
                                                            <ext:Label ID="role" runat="server" Text="绩效科室：">
                                                            </ext:Label>
                                                            <ext:ComboBox ID="JX_dept" runat="server" StoreID="Store4" DisplayField="DEPT_NAME"
                                                                ValueField="DEPT_CODE" TypeAhead="false" LoadingText="Searching..." Width="180"
                                                                PageSize="10" HideTrigger="false" ItemSelector="div.search-item" MinChars="1"
                                                                FieldLabel="科室选择" ListWidth="300">
