<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptSet.aspx.cs" Inherits="GoldNet.JXKP.WebPage.SysManager.DeptSet" %>
                        ...
                        <ext:FormLayout ID="FormLayout2" runat="server">
                            <ext:Anchor>
                                <ext:TextField ID="TextDeptcode" runat="server" DataIndex="dept_code" MsgTarget="Side"
                                    AllowBlank="false" FieldLabel="科室代码" Width="220" ReadOnly="true" />
                            </ext:Anchor>
                            <ext:Anchor>
                                <ext:TextField ID="TextDeptname" runat="server" DataIndex="dept_name" MsgTarget="Side"
                                    AllowBlank="false" FieldLabel="科室名称" Width="220" ReadOnly="true" />
                            </ext:Anchor>
                            <ext:Anchor>
                         ...
                         <h3><span>{DEPT_NAME}</span>{DEPT_CODE}</h3>
                            ...
                            <ext:Anchor>
                                <ext:ComboBox ID="ComAccountdeptcode" runat="server" StoreID="Store2" DisplayField="DEPT_NAME"
                                    ...
                                    MinChars="1" FieldLabel="核算科室" ListWidth="300">
                         ...
                         <h3><span>{DEPT_CODE}</span>{DEPT_NAME}</h3>
                            ...
                            <ext:Anchor>
                                <ext:ComboBox ID="ComLcattr" runat="server"  Width="220" EmptyText="请选择临床属性"
                                    FieldLabel="临床属性" Editable="false">
                                </ext:ComboBox>
                            </ext:Anchor>
                            <ext:Anchor>
                            ...
                            <ext:Anchor>
                                <ext:ComboBox ID="ComShowflag" runat="server" AllowBlank="false" Width="220" EmptyText="选择是否停用"
                                    FieldLabel="是否停用" SelectedIndex="0">
                                    <Items>
                            ...
                            <ext:Anchor>
                                <ext:ComboBox ID="out_or_in" runat="server" AllowBlank="false" Width="220" EmptyText="选择门诊住院"
                            ...
                            <ext:Anchor>
                                <ext:ComboBox ID="ComboBoxGroup" runat="server"  Width="220" EmptyText="请选择组属性"
                                    FieldLabel="组属性" >
                                </ext:ComboBox>
                            </ext:Anchor>
                        </ext:FormLayout>
