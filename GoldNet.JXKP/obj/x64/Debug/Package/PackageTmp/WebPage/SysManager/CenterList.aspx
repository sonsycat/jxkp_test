<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CenterList.aspx.cs" Inherits="GoldNet.JXKP.WebPage.SysManager.CenterList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function backToList() {
            window.navigate("CenterList.aspx");
        }
...
<body>
    ...
    <div>
            ...
            <Reader>
                <ext:JsonReader ReaderID="ID">
                    <Fields>
                        ...
                        <ext:RecordField Name="CENTER_DIRECTOR_ID" />
                        <ext:RecordField Name="CENTER_DIRECTOR_NAME" />
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
                            ...
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_ZLJK" runat="server" Visible="true" AutoWidth="true">
                                        <Items>
                                            ...
                                            <ext:Button ID="Buttonset" runat="server" Text="设置" Icon="Wrench">
                                                <AjaxEvents>
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="专科中心名称" Width="120" Align="left" Sortable="true" MenuDisabled="true"
                                            ColumnID="CENTER_NAME" DataIndex="CENTER_NAME">
                                        </ext:Column>
                                        <ext:Column Header="负责人" Width="200" Align="left" Sortable="true" MenuDisabled="true"
                                            ColumnID="CENTER_DIRECTOR_NAME" DataIndex="CENTER_DIRECTOR_NAME">
                                        </ext:Column>
     ...
     <ext:Window ID="CenterDeptSet" runat="server" Icon="Group" Title="专科中心设置" Width="600"
     ...
     <ext:Window ID="Center_Edit" runat="server" Icon="Group" Title="编辑专科中心" Width="350"
            Height="220"  AutoShow="false" Modal="true" CenterOnLoad="true" AutoScroll="true" ShowOnLoad="false" Resizable="true" StyleSpec="background-color:Transparent;" BodyStyle="background-color:Transparent;">
