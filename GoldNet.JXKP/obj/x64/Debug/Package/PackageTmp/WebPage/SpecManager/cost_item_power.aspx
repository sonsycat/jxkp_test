<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cost_item_power.aspx.cs" Inherits="GoldNet.JXKP.WebPage.SpecManager.cost_item_power" %>
                        ...
                        <ext:ColumnLayout ID="ColumnLayout1" runat="server" FitHeight="true">
                            ...
                            <ext:LayoutColumn ColumnWidth="0.5">
                                ...
                                <ext:Toolbar ID="Toolbar2" runat="server">
                                    <Items>
                                        <ext:Label ID="role" runat="server" Text="成本类别：">
                                        </ext:Label>
                                        <ext:ComboBox ID="ComboBox_Pertype" runat="server" AllowBlank="false" EmptyText="请选择成本类别"
                                            FieldLabel="成本类别选择" Width="120">
                                            <AjaxEvents>
