...
{
    public partial class main_zlxl : System.Web.UI.Page
    {
        /// <summary>
        /// 初始化处理
        /// </summary>
        ...
        private DataTable GetStoreData()
        {
            ...
            DataTable dt = dal.GetGuidess_zlxl(deptcode, stationcode, personid, yearstr, DateTime.Now.ToString("yyyyMMdd"), months).Tables[0];
            return dt;
        }
    }
}
