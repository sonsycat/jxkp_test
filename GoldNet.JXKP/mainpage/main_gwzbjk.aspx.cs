...
{
    public partial class main_gwzbjk : System.Web.UI.Page
    {
        /// <summary>
        /// 初始化处理
        /// </summary>
        ...
        private DataTable GetStoreData()
        {
            ...
            DataTable dt = dal.GetGuides(deptcode, stationcode, personid, yearstr, DateTime.Now.ToString("yyyyMMdd")).Tables[0];
            return dt;
        }
