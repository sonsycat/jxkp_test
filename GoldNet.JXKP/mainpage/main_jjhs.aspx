<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main_jjhs.aspx.cs" Inherits="GoldNet.JXKP.mainpage.main_jjhs" %>
                    ...
                    <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column Header="<div style='text-align:center;'>本期值</div>" Width="96" Align="Right" MenuDisabled="true" Sortable="false"
                                    ColumnID="wcz" DataIndex="WCZ">
                                    <Renderer Fn="rmbMoney" />
                                </ext:Column>
                                <ext:Column Header="<div style='text-align:center;'>同期值</div>" Width="96" Align="Right" MenuDisabled="true" Sortable="false"
                                    ColumnID="wcz" DataIndex="TQWCZ">
                                    <Renderer Fn="rmbMoney" />
                                </ext:Column>
                                <ext:Column Header="<div style='text-align:center;'>上期值</div>" Width="96" Align="Right" MenuDisabled="true" Sortable="false"
