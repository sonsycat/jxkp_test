...
{
    public partial class main_kpi_new : System.Web.UI.Page
    {
        /// <summary>
        /// 初始化处理
        /// </summary>
        ...
        private DataTable GetStoreData()
        {
            ...
            DataTable dt = dal.GetGuidess_mz(deptcode, stationcode, curguide, yearstr, personid, months).Tables[0];
            ...
            pic.BuideGuagePic(dt.Rows.Count > 0 ? Convert.ToString(Convert.ToDouble(temp)) : "0", yearstr+"年"+months+"月门诊量", "目标值：" + mbz, "完成值：" + wcz,"1");
            string guidname = "0";
            string guidmbz = "0";
            string guidwcz = "0";
            string guidwcbfb = "0";
