...
{
    public partial class main_kpi_ss : System.Web.UI.Page
    {
        /// <summary>
        /// 初始化处理
        /// </summary>
        ...
        private DataTable GetStoreData()
        {
            ...
            DataTable dt = dal.GetGuidess_ss(deptcode, stationcode, curguide, yearstr, personid, months).Tables[0];
            ...
            pic.BuideGuagePic(dt.Rows.Count > 0 ? Convert.ToString(Convert.ToDouble(temp)) : "0", yearstr + "年" + months + "月手术量", "目标值：" + mbz, "完成值：" + wcz, "2");
