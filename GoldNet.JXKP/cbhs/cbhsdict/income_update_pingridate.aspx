<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="income_update_pingridate.aspx.cs" Inherits="GoldNet.JXKP.cbhs.cbhsdict.income_update_pingridate" %>
                            ...
                            <TopBar>
                                <ext:Toolbar ID="Toolbar_fjsr" runat="server" Visible="true" AutoWidth="true">
                                    <Items>
                                        ...
                                        <ext:Button ID="Button_del" runat="server" Text="删除" Icon="Delete">
                                            <AjaxEvents>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                             ...
                             <SelectionModel>
                                <ext:RowSelectionModel ID="RowSelectionModel1" runat="server" SingleSelect="true">
                                    <Listeners>
                                        <RowSelect Handler="#{Button_look}.enable()" />
                                        <RowDeselect Handler="if (!#{GridPanel1}.hasSelection()) {#{Button_look}.disable()}" />
                                    </Listeners>
                                </ext:RowSelectionModel>
                            </SelectionModel> 
                            <Listeners>
                                <Command Handler="if(command=='OtherDept'){ Goldnet.AjaxMethods.SetDept(record.data.ID)}" />
                            </Listeners>                          
