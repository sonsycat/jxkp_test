<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appor_prog_sqlexpress_edit.aspx.cs" Inherits="GoldNet.JXKP.appor_prog_sqlexpress_edit" %>
 ...
 <form id="form1" runat="server"  style="background-color:Transparent" >   
    <div>
        <ext:FormPanel ID="FormPanel1" runat="server" Border="false" AutoScroll="false" ButtonAlign="Right"
            ...
            <Body>               
                 <ext:Resizable ID="Resizable1" runat="server" Element="taSQL" Handles="South" Wrap="true" Pinned="true" Height="96"  MinHeight="60" Dynamic="true" />
                <ext:FormLayout ID="FormLayout1" runat="server">
                    ...
                    <ext:Anchor Horizontal="95%">
                        <ext:TextArea runat="server" ID="taSQL"  CausesValidation="true"  FieldLabel="方案SQL"   AllowBlank="false"  Height="200" />
                    </ext:Anchor>
                    <ext:Anchor Horizontal="95%">
