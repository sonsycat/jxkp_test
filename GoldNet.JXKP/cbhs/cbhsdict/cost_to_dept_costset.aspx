<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cost_to_dept_costset.aspx.cs" Inherits="GoldNet.JXKP.cbhs.cbhsdict.cost_to_dept_costset" %>
                                            ...
                                            <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" AutoExpandColumn="ITEM_NAME"
                                                ...
                                                <TopBar>
                                                    <ext:Toolbar ID="Toolbar3" runat="server">
                                                        <Items>
                                                            <ext:Label ID="role" runat="server" Text="已选项目">
                                                            </ext:Label>
