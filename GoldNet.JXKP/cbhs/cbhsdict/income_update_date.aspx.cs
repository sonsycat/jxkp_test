...
{
    public partial class income_update_date : PageBase
    {
        ...
        public void Bindlist(string datetime)
        {
            ...
            DataTable ds = del.GetUpdateData(datetime).Tables[0];
        ...
        protected void Button_add_click(object sender, AjaxEventArgs e)
        {
            ...
            LoadConfig loadcfg = getLoadConfig("income_update_date_detail.aspx");
        ...
        protected void Button_del_click(object sender, AjaxEventArgs e)
        {
            ...
            Cbhs_dict del = new Cbhs_dict();
            del.Delete_date(sm.SelectedRow.RecordID);           
            Bindlist(datetime);
        }
    }
}