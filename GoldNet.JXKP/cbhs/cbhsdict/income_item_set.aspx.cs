...
{
    public partial class income_item_set : System.Web.UI.Page
    {
        ...
        protected void Buttonsave_Click(object sender,EventArgs e)
        {
            try
            {
                ...
                model.ZJCBBL = Convert.ToDouble(ZJCBBL.Value);
                model.JJCBBL = Convert.ToDouble(JJCBBL.Value);
                model.DCCB = Convert.ToDouble(DCCB.Value);
        ...
        protected void EditInit(string class_code)
        {
            ...
            if (dt.Rows[0]["ORDER_DEPT_DISTRIBUT"] != DBNull.Value && !dt.Rows[0]["ORDER_DEPT_DISTRIBUT"].Equals(""))
            {
                ...
                this.ZJCBBL.Value =  Convert.ToDouble(dt.Rows[0]["ZJCBBL"]);
                this.JJCBBL.Value = Convert.ToDouble(dt.Rows[0]["JJCBBL"]);
                this.DCCB.Value = Convert.ToDouble(dt.Rows[0]["DCCB"]);
