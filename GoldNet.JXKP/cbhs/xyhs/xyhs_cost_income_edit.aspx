<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xyhs_cost_income_edit.aspx.cs" Inherits="GoldNet.JXKP.cbhs.xyhs.xyhs_cost_income_edit" %>
                ...
                <ext:FormLayout ID="FormLayout1" runat="server">
                    ...
                    <ext:Anchor>
                        <ext:TextField ID="Text_ItemName" runat="server" DataIndex="rolename" MsgTarget="Side"
                            AllowBlank="false" FieldLabel="成本名称" Width="200" ReadOnly="true" />
                    </ext:Anchor>
                    <ext:Anchor>
                        <ext:ComboBox ID="Combo_ItemType" runat="server" AllowBlank="false" Width="200" EmptyText="请选择收入项目"
                            FieldLabel="收入项目">
