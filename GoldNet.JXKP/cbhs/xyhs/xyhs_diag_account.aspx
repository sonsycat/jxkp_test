<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xyhs_diag_account.aspx.cs"
    Inherits="GoldNet.JXKP.cbhs.xyhs.xyhs_diag_account" %>
    ...
    <div>
        ...
        <ext:Store ID="Store1" runat="server">
            <Reader>
                <ext:JsonReader>
                    <Fields>
                        <ext:RecordField Name="DIAGNOSIS_CODE" Type="String" Mapping="DIAGNOSIS_CODE" />
                        ...
                        <ext:RecordField Name="DIAGNOSIS_COSTS" Type="String" Mapping="DIAGNOSIS_COSTS" />
                        <ext:RecordField Name="DIAGNOSIS" Type="String" Mapping="DIAGNOSIS" />
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar1" runat="server">
                                        <Items>
                                            ...
                                            <ext:Button ID="Button_create" runat="server" Text="病种核算" Icon="ArrowOut">
                                                <AjaxEvents>
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column ColumnID="DIAGNOSIS_CODE" Header="" Width="120" Align="Left" Sortable="true"
                                            DataIndex="DIAGNOSIS_CODE" MenuDisabled="true" Hidden="true" />
                                        <ext:Column ColumnID="DEPT_CODE" Header="" Width="120" Align="Left" Sortable="true"
                                            DataIndex="DEPT_CODE" MenuDisabled="true" Hidden="true" />
                                        <ext:Column ColumnID="DIAGNOSIS_NAME" Header="<div style='text-align:center;'>病种</div>"
                                            Width="120" Align="Left" Sortable="true" DataIndex="DIAGNOSIS_NAME" MenuDisabled="true" />
                                        <ext:Column ColumnID="DEPT_NAME" Header="<div style='text-align:center;'>科室</div>"
                                            Width="120" Align="Left" Sortable="true" DataIndex="DEPT_NAME" MenuDisabled="true" />
                                        <ext:Column ColumnID="COSTS" Header="<div style='text-align:center;'>收入</div>"
                                            Width="120" Align="Left" Sortable="true" DataIndex="COSTS" MenuDisabled="true" />
                                        <ext:Column ColumnID="DIAGNOSIS_COSTS" Header="<div style='text-align:center;'>成本</div>"
                                            Width="120" Align="Left" Sortable="true" DataIndex="DIAGNOSIS_COSTS" MenuDisabled="true" />
                                        <ext:Column ColumnID="DIAGNOSIS" Header="<div style='text-align:center;'>效益</div>"
                                            Width="120" Align="Right" Sortable="true" DataIndex="DIAGNOSIS" MenuDisabled="true">
        ...
        <ext:Window ID="BuideWin" runat="server" Icon="Add" Title="病种核算" Width="350" Height="200"
