<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="benefit_account.aspx.cs" Inherits="GoldNet.JXKP.cbhs.xyhs.benefit_account" %>
...
<body>
    ...
    <ext:ScriptManager ID="ScriptManager1" runat="server" AjaxMethodNamespace="CompanyX" />
            ...
            <Reader>
                <ext:JsonReader ReaderID="DEPT_CODE">
                    <Fields>
                        ...
                        <ext:RecordField Name="INCOME_CHARGES" Type="Float" Mapping="INCOME_CHARGES" />
     ...
     <ext:ViewPort ID="ViewPort1" runat="server">
                            ...
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar1" runat="server">
                                        <Items>
                                            ...
                                            <ext:Button ID="Button_create" runat="server" Text="核算生成" Icon="DatabaseGo">
                                            <AjaxEvents>
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="INCOME_CHARGES" Header="<div style='text-align:center;'>实际收入</div>" Width="90" Align="Right" Sortable="true"
                                            DataIndex="INCOME_CHARGES" MenuDisabled="true" >
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TOTAL_COSTS" Header="<div style='text-align:center;'>总成本</div>" Width="90" Align="Right" Sortable="true"
                                            DataIndex="TOTAL_COSTS" MenuDisabled="true" >
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <ext:Column ColumnID="DIR_COSTS" Header="<div style='text-align:center;'>直接成本</div>" Width="90" Align="Right" Sortable="true"
                                            DataIndex="DIR_COSTS" MenuDisabled="true" >
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <ext:Column ColumnID="INDIR_COSTS" Header="<div style='text-align:center;'>间接成本</div>" Width="90" Align="Right" Sortable="true"
                                        ...
                                        <ext:Column ColumnID="BENEFIT" Header="<div style='text-align:center;'>效益</div>" Width="90" Align="Right" Sortable="true"
                                         ...
                                         <ext:CommandColumn Width="60" Align="Center" Header="<div style='text-align:center;'>构成比</div>" >
                                            <Commands>
                                                <ext:GridCommand Icon="CogStart" CommandName="SR_SCALE"  >
                                                    <ToolTip Text="收入构成比" />
                                                </ext:GridCommand>
                                                <ext:CommandSeparator />
                                                <ext:GridCommand Icon="CogStart" CommandName="CB_SCALE"  >
                                                    <ToolTip Text="成本构成比" />
                                                </ext:GridCommand>
                                            </Commands>
                                        </ext:CommandColumn>
                                        <ext:CommandColumn Width="60" Align="Center" Header="<div style='text-align:center;'>平衡线</div>" Hidden="true" >
                                            <Commands>
        ...
        <ext:Window ID="CBScaleWin" runat="server" Icon="Group" Title="成本构成比" Width="550" Height="410"
        ...
        <ext:Window ID="SRScaleWin" runat="server" Icon="Group" Title="收入构成比" Width="550" Height="410"
            AutoShow="false" Modal="true" CenterOnLoad="true" AutoScroll="true" ShowOnLoad="false"
            Resizable="true" StyleSpec="background-color:Transparent;" BodyStyle="background-color:Transparent;">
        </ext:Window>
        <ext:Window ID="DETAILWin" runat="server" Icon="Group" Title="收支平衡线" Width="680" Height="450"
            AutoShow="false" Modal="true" CenterOnLoad="true" AutoScroll="true" ShowOnLoad="false"
            Resizable="true" StyleSpec="background-color:Transparent;" BodyStyle="background-color:Transparent;">
        </ext:Window>
    </div>
