<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xyhs_dept_item_account_detail.aspx.cs" Inherits="GoldNet.JXKP.cbhs.xyhs.xyhs_dept_item_account_detail" %>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column ColumnID="ITEM_CODE" Header="<div style='text-align:center;'>项目编码</div>" Width="90" Align="left" Sortable="true"
