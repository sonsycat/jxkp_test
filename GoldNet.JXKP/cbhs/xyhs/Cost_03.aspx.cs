...
{
    public partial class Cost_03 : PageBase
    {
        ...
        private void data(string stdate, string enddate)
        {
            ...
            //string wheres2 = " and substr(item_code,0,1) not in ('J','K','L','M')";
            DataTable table = report_dal.GetCost03("0", stdate, enddate);
            Session.Remove("Cost_03");
            Session["Cost_03"] = table;
            for (int i = 0; i < table.Columns.Count; i++)
            {
                ...
                //cl.Header = table.Columns[i].ColumnName.ToString();
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            header[0].Text = cbbYear.SelectedItem.Value.ToString() + "年" + cbbmonth.SelectedItem.Value.ToString() + "月份至" + ccbYearTo.SelectedItem.Value.ToString() + "年" + ccbMonthTo.SelectedItem.Value.ToString() + "月份" + "医院临床服务类科室全成本构成分析表（医疗成本）</th></tr><tr>";
            ...
            MHeaderTabletoExcel( (DataTable)Session["Cost_03"] , header, "医成本03表"+DateTime.Now, null, 0);
        }
