<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dept_Cost_Union.aspx.cs" Inherits="GoldNet.JXKP.cbhs.xyhs.Operation.Dept_Cost_Union" %>
                                    ...
                                    <Columns>
                                        <ext:LayoutColumn ColumnWidth="1">
                                            ...
                                            <ext:ComboBox ID="months" runat="server" Width="60" AllowBlank="true" EmptyText="请选择月..."
                                             ...
                                             <ext:ToolbarTextItem ID="ToolbarTextItem1" runat="server" Text="科室" />
                                                          <ext:ComboBox ID="ComboBoxdept" runat="server" StoreID="Store3" DisplayField="DEPT_NAME"
                                                                    AllowBlank="true" ValueField="DEPT_CODE" TypeAhead="false" LoadingText="Searching..."
                                                                    Width="160" ListWidth="160" PageSize="10" ItemSelector="div.search-item" MinChars="1">
                                                                 ...
                                                                 <ext:ToolbarTextItem ID="ToolbarTextItem2" runat="server" Text="项目" />
                                                                 <ext:ComboBox ID="ComboBoxitem" runat="server" StoreID="Store2" DisplayField="ITEM_NAME"
                                                                    AllowBlank="true" ValueField="ITEM_CODE" TypeAhead="false" LoadingText="Searching..."
                                                                    Width="180" ListWidth="220" PageSize="10" ItemSelector="div.search-item" MinChars="1">
                                                            ...
                                                            <ext:Button ID="Button_ext" runat="server" Text="成本归集" Icon="Delete" >
                                                                <AjaxEvents>
                                                                    <Click OnEvent="Button_ext_click">
                                                                        <Confirmation ConfirmRequest="true" Title="系统提示" Message="将重新提取成本数据,<br/>是否继续?" />
                                                                        <ExtraParams>
                                                                        </ExtraParams>
                                                                        <EventMask Msg="载入中..." ShowMask="true" />
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                          <ext:Column ColumnID="DEPT_NAME" Header="<div style='text-align:center;'>科室</div>"
                                                            Width="160" Align="left" DataIndex="DEPT_NAME" MenuDisabled="true">
                                                          
                                                        </ext:Column>
                                                        <ext:Column ColumnID="ITEM_NAME" Header="<div style='text-align:center;'>项目</div>"
                                                            Width="220" Align="left" DataIndex="ITEM_NAME" MenuDisabled="true">
