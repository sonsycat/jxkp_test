...
{
    public partial class Dept_Cost_Input : PageBase
    {
        /// <summary>
        /// 初始化处理
        /// </summary>
        ...
        protected void Bindlist()
        {
            ...
            DataTable dt = dal.GetdDeptCost(date, "0").Tables[0];
            ...
            else
            {
                try
                {
                    for (int i = 0; i < selectRow.Length; i++)
                    {
                        ...
                        if (!itemode.Equals(""))
                        {
                            dal.DelDeptCosts(itemode, deptcode, date, "0");
                        }
                    }
        ...
        protected void Button_Save_click(object sender, AjaxEventArgs e)
        {
            ...
            if (selectRow != null)
            {
                ...
                try
                {
                    dal.SaveDeptCosts(selectRow, date, operators, "0");
