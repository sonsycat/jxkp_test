...
{
    public partial class xyhs_costs_item : System.Web.UI.Page
    {
        ...
        public string TreeBuild()
        {
            ...
            DataTable l_TreeDt = dal.GetCosttype().Tables[0];
            ...
            for (int i = 0; i < l_TreeDt.Rows.Count; i++)
            {
                ...
                node.NodeID = l_TreeDt.Rows[i]["ITEM_CODE"].ToString();
                node.SingleClickExpand = true;
                node.Text = l_TreeDt.Rows[i]["ITEM_NAME"].ToString();
        ...
        protected void Button_del_click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dal.DelCostItem(item_code);
                Goldnet.Ext.Web.ScriptManager scManager = Goldnet.Ext.Web.ScriptManager.GetInstance(this.Page);
                scManager.AddScript("RefreshData('删除成功');");
        ...
        {
            LoadConfig loadcfg = getLoadConfig("xyhs_cost_item_type.aspx");
            TypeWin.Center();
        ...
        protected void Button_allcostbset_click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                loadcfg.Params.Add(new Goldnet.Ext.Web.Parameter("item_code", item_code));
                this.showAllcostWin(loadcfg);
            }
        }

        //显示全成本设置窗口
        private void showAllcostWin(LoadConfig loadcfg)
        {
            AllcostWin.Center();
            AllcostWin.ClearContent();
            AllcostWin.Show();
            AllcostWin.LoadContent(loadcfg);
        }
        ...
        public void GridPanelRefresh(string ITEM_TYPE)
        {
            XyhsDetail dal = new XyhsDetail();
            DataTable dt = dal.GetXyhsCostItemByItemType(ITEM_TYPE);
