<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cost_14.aspx.cs" Inherits="GoldNet.JXKP.cbhs.xyhs.Report.Cost_14" %>
                                ...
                                <Body>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="SReport" Border="true"
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:ExtColumn ColumnID="ZBMC" Header="<div style='text-align:center;'>指标名称</div>"
                                                    Width="120" DataIndex="ZBMC" MenuDisabled="true">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="HC" Header="<div style='text-align:center;'>行次</div>"
                                                    Width="120" DataIndex="HC" MenuDisabled="true" Align="Right">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ZBZ" Header="<div style='text-align:center;'>值</div>" Width="120"
                                                    DataIndex="ZBZ" MenuDisabled="true" Align="Right">
                                                </ext:ExtColumn>
