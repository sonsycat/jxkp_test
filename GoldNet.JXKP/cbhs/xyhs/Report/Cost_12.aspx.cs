...
{
    public partial class Cost_12 : PageBase
    {
        ...
        private void data(string stdate, string enddate)
        {
            ...
            DataTable table = report_dal.GetCost12(stdate, enddate);

            Session.Remove("Cost_12");
            Session["Cost_12"] = table;
            for (int i = 0; i < table.Columns.Count; i++)
            {
                ...
                if (cl.Header.Equals("DEPT_TYPE") || cl.Header.Equals("ACCOUNT_DEPT_CODE"))
                {
                    cl.Hidden = true;
                }
                cl.Sortable = false;
