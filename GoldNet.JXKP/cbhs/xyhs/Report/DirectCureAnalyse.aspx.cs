...
{
    public partial class DirectCureAnalyse : PageBase
    {
        ...
        private void data(string stdate, string enddate, string sdate)
        {
            ...
            DataTable table = report_dal.GetDirectCureAnalyse(sdate, stdate, enddate);
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            DataTable dt = report_dal.GetDirectCureAnalyse(GetSDate(), GetBeginDate(), GetEndDate());
            ...
            MHeaderTabletoExcel(dt, header, "直接医疗科室收入成本收益明细表[本科室开单本科室执行]", mergeCellNums, 0); 
        }
