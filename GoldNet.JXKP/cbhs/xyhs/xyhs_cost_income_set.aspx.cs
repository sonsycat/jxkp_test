...
{
    public partial class xyhs_cost_income_set : PageBase
    {
        ...
        public void Bindlist()
        {
            ...
            DataTable dt = sd.GetCost_incomeList("").Tables[0];
        ...
        protected void Button_Save_click(object sender, AjaxEventArgs e)
        {
            ...
            if (selectRow != null)
            {
                try
                {
                    ...
                    sd.SaveCost_Income(selectRow);
                    this.ShowMessage("提示", "设置成功！");
                    Store_RefreshData(null, null);
                }
                catch( Exception ex)
                {
                    this.ShowMessage("系统提示", ex.ToString());
                }
            }
        }
