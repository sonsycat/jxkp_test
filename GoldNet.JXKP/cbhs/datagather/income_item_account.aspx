<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="income_item_account.aspx.cs"
    Inherits="GoldNet.JXKP.cbhs.datagather.income_item_account" %>
                            ...
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar1" runat="server">
                                        <Items>
                                            ...
                                            <ext:Label ID="Label3" runat="server" Text="总管理成本：" Width="60" />
                                            <ext:NumberField ID="AllMagCosts" runat="server" Width="80"  Disabled ="true"/>
                                            <ext:ToolbarSeparator ID="ToolbarSeparator1" runat="server" />
                                            <ext:Button ID="Button_create" runat="server" Text="按收入项目核算" Icon="DatabaseGo">
                                                <AjaxEvents>
                                                    <Click OnEvent="Button_create_click" Timeout="900000">
                                                        <Confirmation ConfirmRequest="true" Title="系统提示" Message="将按收入项目核算,<br/>是否继续?" />
                                                        <ExtraParams>
                                                        </ExtraParams>
                                                        <EventMask Msg="载入中..." ShowMask="true" />
                                                    </Click>
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="ITEM_NAME" Header="<div style='text-align:center;'>项目名称</div>" Width="90" Align="left" Sortable="true"
