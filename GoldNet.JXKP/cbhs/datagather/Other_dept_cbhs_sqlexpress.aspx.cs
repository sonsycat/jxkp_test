...
{
    public partial class Other_dept_cbhs_sqlexpress : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Store1.DataSource = dal_appor.GetOthersqlexpress("");
                Store1.DataBind();
            }
        }
        //编辑按钮触发事件
        protected void Btn_Edit_Click(object sender, AjaxEventArgs e)
        {
            ...
            if (selectRow != null)
            {
                LoadConfig loadcfg = getLoadConfig("Other_dept_cbhs_sqlexpress_edit.aspx");
                loadcfg.Params.Add(new Goldnet.Ext.Web.Parameter("ID", selectRow[0]["ID"]));
                loadcfg.Params.Add(new Goldnet.Ext.Web.Parameter("Mode", "Edit"));
        ...
        {
            LoadConfig loadcfg = getLoadConfig("Other_dept_cbhs_sqlexpress_edit.aspx");
            loadcfg.Params.Add(new Goldnet.Ext.Web.Parameter("Mode", "Add"));
            showDetailWin(loadcfg);
        }
        //添加按钮触发事件
        protected void Btn_Del_Click(object sender, AjaxEventArgs e)
        {
            ...
            if (selectRow != null)
            {
                ...
                {
                    ShowDataError(ex.ToString(), Request.Url.LocalPath, "DeleteOthersql");
                }
