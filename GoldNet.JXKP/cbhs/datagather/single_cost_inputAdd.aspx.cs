...
{
    public partial class single_cost_inputAdd : PageBase
    {
        ...
        protected void UploadClick(object sender, AjaxEventArgs e)
        {
           ...
           //// string aa = Server.MapPath(this.photoimg.FileName.ToString());
           //// string bb = HttpContext.Current.Server.MapPath(this.photoimg.FileName.ToString());
           // string filePath = this.photoimg.PostedFile.FileName;
           // //string aaa = System.IO.Path.GetFileName(this.photoimg.FileName.ToString());
                ...
                using (OleDbConnection conn = new OleDbConnection(OracleOledbBase.ConnString))
                {
                    ...
                    using (OleDbTransaction myTrans = conn.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            this.Session["LongActionProgress"] = "2:正在记录奖金(2/2)";
                            //添加奖金主表
