...
{
    public partial class diag_account : PageBase
    {
        ...
        private void Bindlist(string date_time)
        {
            ...
            DataTable dt = dal.GetDiagAccountData(date_time).Tables[0];
        ...
        protected void Button_create_click(object sender, EventArgs e)
        {
            ...
            try
            { 
                rtmsg = dal.Exec_Sp_Diag_Account(date_time);
                if (rtmsg == "")
                {
        ...
        protected void Button_OutExcel_click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                dt.Columns["DIAGNOSIS_NAME"].ColumnName = "病种名称";
                ...
                ex.ExportToLocal(dt, this.Page, "xls", "病种核算数据");
            }
        }
    }
}
