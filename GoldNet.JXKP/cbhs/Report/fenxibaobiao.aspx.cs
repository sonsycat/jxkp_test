...
{
    public partial class fenxibaobiao : PageBase
    {
        DataTable table;
        /// <summary>
        /// 初始化处理
        ...
        private void data(string stdate, string enddate)
        {
           ...
           // string deptcode = this.DeptFilter("");
            ...
            table = report_dal.Fenxibaobiao(stdate, enddate);
        ...
        protected void Btn_Query_Click(object sender, AjaxEventArgs e)
        {
            ...
            Session.Remove("fenxibaobiao");
            Session["fenxibaobiao"] = table;
        }
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            DataTable dt = report_dal.Fenxibaobiao(GetBeginDate(), GetEndDate()); 
