<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClinicDetail.aspx.cs" Inherits="GoldNet.JXKP.cbhs.Report.ClinicDetail" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="DOCTOR">
                    </ext:RecordField>
                    <ext:RecordField Name="CLINIC_TYPE">
                    </ext:RecordField>
                    <ext:RecordField Name="W_NUMBERS">
                    </ext:RecordField>
                    <ext:RecordField Name="H_NUMBERS">
                    </ext:RecordField>
                    <ext:RecordField Name="WNUM">
                    </ext:RecordField>
                    <ext:RecordField Name="HNUM">
                    </ext:RecordField>
                </Fields>
            </ext:JsonReader>
        </Reader>
                                        ...
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbbType" runat="server"   ReadOnly="true" ForceSelection="true" SelectOnFocus="true" SelectedIndex="0">
                                                <Items>
                                                    ...
                                                    <ext:ListItem Text="副主任号" Value="副主任号" />
                                                    <ext:ListItem Text="正主任号" Value="正主任号" />
                                                    <ext:ListItem Text="知名专家" Value="知名专家" />
                                                    <ext:ListItem Text="特需专家" Value="特需专家" />
                                                </Items>
                                            </ext:ComboBox>
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:ExtColumn ColumnID="DEPT_NAME" Header="<div style='text-align:center;'>科室</div>"
                                                    Width="120" DataIndex="DEPT_NAME" MenuDisabled="true" Align="left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="DOCTOR" Header="<div style='text-align:center;'>医生</div>"
                                                    Width="120" DataIndex="DOCTOR" MenuDisabled="true" Align="left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="CLINIC_TYPE" Header="<div style='text-align:center;'>费别</div>"
                                                    Width="120" DataIndex="CLINIC_TYPE" MenuDisabled="true" Align="left">
                                                </ext:ExtColumn>
                                                 <ext:ExtColumn ColumnID="W_NUMBERS" Header="<div style='text-align:center;'>工作日标准</div>"
                                                    Width="120" DataIndex="W_NUMBERS" MenuDisabled="true" Align="Right">
                                                   
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="H_NUMBERS" Header="<div style='text-align:center;'>双休日标准</div>"
                                                    Width="120" DataIndex="H_NUMBERS" MenuDisabled="true" Align="Right">
                                               
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="WNUM" Header="<div style='text-align:center;'>工作日工作量</div>"
                                                    Width="120" DataIndex="WNUM" MenuDisabled="true" Align="Right">
                                                   
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="HNUM" Header="<div style='text-align:center;'>双休日工作量</div>"
                                                    Width="120" DataIndex="HNUM" MenuDisabled="true" Align="Right">
