...
{
    public partial class HospitalPerformRealIncome : PageBase
    {
        ...
        private void Query()
        {
            ...
            DataTable table = report_dal.GetHospitalPerformRealIncome(GetBeginDate(), GetEndDate(), balance, deptcode, depttype);
            if (table != null && table.Rows.Count > 0)
            {
                ...
                Session.Remove("HospitalPerformRealIncome");
                Session["HospitalPerformRealIncome"] = STable;
            }
            else
            {
        ...
        {
            if (Session["HospitalPerformRealIncome"] != null)
            {
                ExportData ex = new ExportData();
                DataTable dt = (DataTable)Session["HospitalPerformRealIncome"];
                ...
                ex.ExportToLocal(dt, this.Page, "xls", "住院执行科室实际收入统计表");
            }
        }
        /// <summary>
        /// 开始时间
