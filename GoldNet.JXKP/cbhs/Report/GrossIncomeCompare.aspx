<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrossIncomeCompare.aspx.cs" Inherits="GoldNet.JXKP.GrossIncomeCompare" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="MZ1" />
                    <ext:RecordField Name="ZY1" />
                    <ext:RecordField Name="TOTAL1" />
                    <ext:RecordField Name="MZ2" />
                    <ext:RecordField Name="ZY2" />
                    <ext:RecordField Name="TOTAL2" />
                    <ext:RecordField Name="MZ3" />
                    <ext:RecordField Name="ZY3" />
                    <ext:RecordField Name="TOTAL3" />
                    <ext:RecordField Name="TOTALADD" />
                </Fields>
            </ext:JsonReader>
        </Reader>
    </ext:Store>
                                ...
                                <Body>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="SReport" Border="true"
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:ExtColumn ColumnID="DEPT_TYPE" Header="<div style='text-align:center;'>科室类别</div>" Width="100" DataIndex="DEPT_TYPE"
                                                    MenuDisabled="true" Align="Left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ID" Header="<div style='text-align:center;'>排序</div>" Width="40" DataIndex="ID"
                                                    MenuDisabled="true" Align="Left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="DEPT_NAME" Header="<div style='text-align:center;'>科室</div>" Width="100" DataIndex="DEPT_NAME" MenuDisabled="true"
                                                    Align="Left">
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="MZ1" Header="<div style='text-align:center;'>门诊</div>" Width="100" DataIndex="MZ1" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ZY1" Header="<div style='text-align:center;'>住院</div>" Width="100" DataIndex="ZY1" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="TOTAL1" Header="<div style='text-align:center;'>合计</div>" Width="100" DataIndex="TOTAL1" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="MZ2" Header="<div style='text-align:center;'>门诊</div>" Width="100" DataIndex="MZ2" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ZY2" Header="<div style='text-align:center;'>住院</div>" Width="100" DataIndex="ZY2" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="TOTAL2" Header="<div style='text-align:center;'>合计</div>" Width="100" DataIndex="TOTAL2" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="MZ3" Header="<div style='text-align:center;'>门诊</div>" Width="100" DataIndex="MZ3" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ZY3" Header="<div style='text-align:center;'>住院</div>" Width="100" DataIndex="ZY3" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="TOTAL3" Header="<div style='text-align:center;'>总收入</div>" Width="100" DataIndex="TOTAL3" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="TOTALADD" Header="<div style='text-align:center;'>同比增长额</div>" Width="100" DataIndex="TOTALADD" MenuDisabled="true"
                                                    Align="Right">
                                                     <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                            </Columns>
                                            <HeadRows>
                                                <ext:ExtRows>
                                                    <Rows>
                                                        ...
                                                        <ext:ExtRow Header="本期" ColSpan="3" Align="Center" />
                                                        <ext:ExtRow Header="同期" ColSpan="3" Align="Center" />
                                                        <ext:ExtRow Header="同比增长" ColSpan="4" Align="Center" />
                                                    </Rows>
                                                </ext:ExtRows>
                                            </HeadRows>
                                        </ExtColumnModel>
