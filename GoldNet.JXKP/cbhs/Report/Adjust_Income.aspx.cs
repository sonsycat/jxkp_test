...
{
    public partial class Adjust_Income : PageBase
    {
        ...
        protected void Btn_Query_Click(object sender, AjaxEventArgs e)
        {
            ...
            DataTable dt = report_dal.GetAdjust_Income(GetBeginDate(), GetEndDate(), balance, dept);
            if (dt != null)
            {
                SReport.DataSource = dt;
                SReport.DataBind();
                Session.Remove("Adjust_Income");
                Session["Adjust_Income"] = dt;
            }
            else
            {
        ...
        {
            if (Session["Adjust_Income"] != null)
            {
                ExportData ex = new ExportData();
                DataTable dt = (DataTable)Session["Adjust_Income"];
