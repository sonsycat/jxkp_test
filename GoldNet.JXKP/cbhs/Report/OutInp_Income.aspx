<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutInp_Income.aspx.cs" Inherits="GoldNet.JXKP.cbhs.Report.OutInp_Income" %>
        ...
        <Reader>
            <ext:JsonReader>
                <Fields>
                    ...
                    <ext:RecordField Name="XY">
                    </ext:RecordField>
                    <ext:RecordField Name="ZCY">
                    </ext:RecordField>
                    <ext:RecordField Name="YNZJ">
                    </ext:RecordField>
                    <ext:RecordField Name="XYHJ">
                    </ext:RecordField>
                    <ext:RecordField Name="ZYP">
                    </ext:RecordField>
                    <ext:RecordField Name="XYP">
                    </ext:RecordField>
                    <ext:RecordField Name="FJMJ">
                    </ext:RecordField>
                    <ext:RecordField Name="PFKL">
                    </ext:RecordField>
                    <ext:RecordField Name="YPJP">
                    </ext:RecordField>
                                    ...
                                    <ext:ExtGridPanel ID="GridPanel_Show" runat="server" StoreID="SReport" Border="true"
                                        ...
                                        <ExtColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:ExtColumn ColumnID="XY" Header="<div style='text-align:center;'>西药费</div>"
                                                    Width="120" DataIndex="XY" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ZCY" Header="<div style='text-align:center;'>中成药</div>"
                                                    Width="120" DataIndex="ZCY" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="YNZJ" Header="<div style='text-align:center;'>院内制剂</div>"
                                                    Width="120" DataIndex="YNZJ" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="XYHJ" Header="<div style='text-align:center;'>西药合计</div>"
                                                    Width="120" DataIndex="XYHJ" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ZYP" Header="<div style='text-align:center;'>中饮片</div>"
                                                    Width="120" DataIndex="ZYP" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="XYP" Header="<div style='text-align:center;'>小饮片</div>"
                                                    Width="120" DataIndex="XYP" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="FJMJ" Header="<div style='text-align:center;'>粉剂免煎</div>"
                                                    Width="120" DataIndex="FJMJ" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="PFKL" Header="<div style='text-align:center;'>配方颗粒</div>"
                                                    Width="120" DataIndex="PFKL" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="YPJP" Header="<div style='text-align:center;'>饮片精品</div>"
                                                    Width="120" DataIndex="YPJP" MenuDisabled="true" Align="Right">
                                                    <Renderer Fn="rmbMoney" />
                                                </ext:ExtColumn>
                                                <ext:ExtColumn ColumnID="ZYHJ" Header="<div style='text-align:center;'>中药合计</div>"
