<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KSHSXX_BBXMSR.aspx.cs"
    Inherits="GoldNet.JXKP.cbhs.Report.KSHSXX_BBXMSR" %>
...
<body>
    ...
    <div>
        ...
        <ext:Store runat="server" ID="Store1" AutoLoad="true" OnRefreshData="Store_RefreshData">
            <Reader>
                <ext:JsonReader ReaderID="CLASS_TYPE">
                    <Fields>
                        <ext:RecordField Name="CLASS_TYPE" />
                        <ext:RecordField Name="CLASS_NAME" />
                        <ext:RecordField Name="SRHJ" />
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" BodyBorder="false" AutoScroll="true"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="项目名称" Width="130" ColumnID="CLASS_NAME" DataIndex="CLASS_NAME">
                                        </ext:Column>
                                        <ext:Column Header="收入合计" Width="90" ColumnID="SRHJ" DataIndex="SRHJ">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
                                        <ext:Column Header="实收收入" Width="90" ColumnID="AA" DataIndex="AA">
                                            <Renderer Fn="rmbMoney" />
                                        </ext:Column>
