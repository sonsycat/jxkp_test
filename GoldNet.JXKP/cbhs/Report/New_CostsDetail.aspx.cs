...
{
    public partial class New_CostsDetail : PageBase
    {
        ...
        protected void Btn_Query_Click(object sender, AjaxEventArgs e)
        {
            ...
            DataTable dt = dal_report.GetNew_CostsDetail(GetBeginDate());
            if (dt != null)
            {
                ...
                for (int i = 0; i < dt.Columns.Count; i++)
                {
                    ...
                    if (dt.Columns[i].ColumnName != "DEPT_CODE")
                    {
                        ...
                        if (dt.Columns[i].ColumnName != "项目" && dt.Columns[i].ColumnName != "核算类别")
                        {
