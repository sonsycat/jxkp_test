...
{
    public partial class Costs_Report : PageBase
    {
        DataTable table;
        /// <summary>
        /// 初始化处理
        ...
        private void data(string stdate, string enddate)
        {
            ...
            table = report_dal.GetCostReport(stdate, enddate, balance, costtype, this.deptType.SelectedItem.Value.ToString());
        ...
        protected void Btn_Query_Click(object sender, AjaxEventArgs e)
        {
            ...
            Session.Remove("CostsReport");
            Session["CostsReport"] = table;
        }
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            //string balance = this.cbbType.SelectedItem.Value == "" ? "1" : this.cbbType.SelectedItem.Value;
            //string costtype = this.costtype.SelectedItem.Value == "" ? "1" : this.costtype.SelectedItem.Value;
            //DataTable dt = report_dal.GetCostReport(GetBeginDate(), GetEndDate(), balance, costtype, this.deptType.SelectedItem.Value.ToString());
            ...
            //    }
            //}
            //this.outexcel(dt, "成本汇总报表");

            if (Session["CostsReport"] != null)
            {
                DataTable dt = (DataTable)Session["CostsReport"];
                //this.outexcel(aa, "成本汇总报表");
                ...
                ISheet sheet = workbook.CreateSheet("成本汇总报表");
                ...
                using (MemoryStream exportData = new MemoryStream())
                {
                    ...
                    {
                        Response.AddHeader("content-disposition", "attachment; filename=" + s_date + "成本汇总报表.xls");
                    }
                    else
                    {
                        Response.AddHeader("content-disposition", "attachment; filename=" + s_date + "至" + e_date + "成本汇总报表.xls");
                    }
