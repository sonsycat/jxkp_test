...
{
    public partial class HMtrl_Detail : PageBase
    {
        ...
        private void data(string stdate, string enddate)
        {
            ...
            DataTable table = report_dal.GetMtrlDetail(stdate, enddate,"2");
        ...
        {
            Report report_dal = new Report();
            DataTable dt = report_dal.GetMtrlDetail(GetBeginDate(), GetEndDate(),"2");
