...
{
    public partial class ClinicPerformRealIncome : PageBase
    {
        ...
        private void Query()
        {
            ...
            DataTable table = report_dal.GetClinicPerformRealIncome(GetBeginDate(), GetEndDate(), deptcode, depttype);
            if (table != null && table.Rows.Count > 0)
            {
                ...
                Session.Remove("ClinicPerformRealIncome");
                Session["ClinicPerformRealIncome"] = STable;
            }
            else
            {
        ...
        {
            if (Session["ClinicPerformRealIncome"] != null)
            {
                ExportData ex = new ExportData();
                DataTable dt = (DataTable)Session["ClinicPerformRealIncome"];
                ...
                ex.ExportToLocal(dt, this.Page, "xls", "门诊执行科室实际收入统计表");
            }
        }
        /// <summary>
        /// 开始时间
