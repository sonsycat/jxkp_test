...
{
    public partial class ClinicOrderValuationIncome : PageBase
    {
        ...
        private void Query()
        {
            ...
            DataTable table = report_dal.GetClinicOrderValuationIncome(GetBeginDate(), GetEndDate(), deptcode, depttype);
            if (table != null && table.Rows.Count > 0)
            {
                ...
                Session.Remove("ClinicOrderValuationIncome");
                Session["ClinicOrderValuationIncome"] = STable;
            }
            else
            {
        ...
        {
            if (Session["ClinicOrderValuationIncome"] != null)
            {
                ExportData ex = new ExportData();
                DataTable dt = (DataTable)Session["ClinicOrderValuationIncome"];
                ...
                ex.ExportToLocal(dt, this.Page, "xls", "门诊开单科室计价收入统计表");
            }
        }
        /// <summary>
        /// 开始时间
