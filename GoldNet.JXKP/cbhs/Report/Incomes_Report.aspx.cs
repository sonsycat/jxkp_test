...
{
    public partial class Incomes_Report : PageBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        private void data(string stdate, string enddate)
        {
            ...
            string costtype = this.costtype.SelectedItem.Value;
            DataTable table = report_dal.GetIncomesReport(stdate, enddate, balance, costtype, this.deptType.SelectedItem.Value.ToString());
            ...
            for (int i = 0; i < table.Columns.Count; i++)
            {
                ...
                if (cl.Header.Equals("科室名称") || cl.Header.Equals("类别"))
                {
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            string costtype = this.costtype.SelectedItem.Value;
            DataTable dt = report_dal.GetIncomesReport(GetBeginDate(), GetEndDate(), balance, costtype, this.deptType.SelectedItem.Value.ToString());
            ...
            ISheet sheet = workbook.CreateSheet("收入汇总报表");
            ...
            using (MemoryStream exportData = new MemoryStream())
            {
                ...
                {
                    Response.AddHeader("content-disposition", "attachment; filename=" + s_date + "收入汇总报表.xls");
                }
                else
                {
                    Response.AddHeader("content-disposition", "attachment; filename=" + s_date + "至" + e_date + "收入汇总报表.xls");
                }
