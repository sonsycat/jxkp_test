<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptIncome_Detail.aspx.cs" Inherits="GoldNet.JXKP.DeptIncome_Detail" %>
                                                    ...
                                                    <ext:PagingToolbar ID="PagingToolBar2" runat="server" PageSize="20" StoreID="Store2"
                                                      ...
                                                      <Items>
                                                            <ext:TextField ID="txt_SearchTxt" runat="server" EmptyText="查找信息">
                                                                <ToolTips>
                                                                    <ext:ToolTip ID="ToolTip1" runat="server" Html="根据医生姓名,病人姓名，病人ID模糊查找">
                                                                    </ext:ToolTip>
                                                                </ToolTips>
                                                            </ext:TextField>
