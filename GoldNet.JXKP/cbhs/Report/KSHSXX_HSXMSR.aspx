<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KSHSXX_HSXMSR.aspx.cs"
    Inherits="GoldNet.JXKP.cbhs.Report.KSHSXX_HSXMSR" %>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel1" runat="server" BodyBorder="false" AutoScroll="true"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="项目名称" Width="130" ColumnID="ITEM_NAME" DataIndex="ITEM_NAME">
                                        </ext:Column>
