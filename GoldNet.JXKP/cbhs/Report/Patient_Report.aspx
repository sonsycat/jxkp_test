<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Patient_Report.aspx.cs"
    Inherits="GoldNet.JXKP.Patient_Report" %>
...
<body>
    ...
    <ext:Store ID="Store1" runat="server">
        <Reader>
            <ext:JsonReader ReaderID="PATIENT_ID">
                <Fields>
                </Fields>
            </ext:JsonReader>
        </Reader>
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0">
                                        <Items>
                                            ...
                                            <ext:Button ID="btn_r_Excel" runat="server" Text="读取Excel" Icon="Zoom">
                                                <AjaxEvents>
                                                    <Click OnEvent="Btn_Excel_Click" Timeout="99999999">
                                                        <EventMask Msg="查询中......" ShowMask="true" />
                                                    </Click>
                                                </AjaxEvents>
                                            </ext:Button>
