<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentDepreciation.aspx.cs"
    Inherits="GoldNet.JXKP.EquipmentDepreciation" %>
                    ...
                    <Columns>
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:Panel runat="server" ID="p11" AutoScroll="true" Border="false">
                                ...
                                <Body>
                                    <center>
                                        <ext:Label runat="server" ID="lTitle" Text="各单位成本项目明细表" StyleSpec="font-size: 24px;letter-spacing:1px;margin: 10px 0 0 20px;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;padding-top: 12px;padding-bottom: 3px;">
                                        </ext:Label>
                                    </center>
