...
{
    public partial class ward_outp : PageBase
    {
        DataTable table;
        /// <summary>
        /// 初始化处理
        ...
        private void data(string stdate, string enddate)
        {
            ...
            table = report_dal.GetWardoutp(stdate, enddate, deptcode, costtype, depttype, incomestype);
        ...
        protected void Btn_Query_Click(object sender, AjaxEventArgs e)
        {
            ...
            Session.Remove("wardoutp");
            Session["wardoutp"] = table;
        }
        ...
        protected void OutExcel(object sender, EventArgs e)
        {
            ...
            string incomestype = this.incomestype.SelectedItem.Value == "" ? "0" : this.incomestype.SelectedItem.Value;
            string costtype = this.costtype.SelectedItem.Value == "" ? "1" : this.costtype.SelectedItem.Value;
            DataTable dt = report_dal.GetWardoutp(GetBeginDate(), GetEndDate(), deptcode, costtype, this.deptType.SelectedItem.Value, incomestype);
            ...
            using (MemoryStream exportData = new MemoryStream())
            {
                ...
                {
                    Response.AddHeader("content-disposition", "attachment; filename=" + s_date + "门诊收入统计表（核算前）.xls");
                }
                else
                {
                    Response.AddHeader("content-disposition", "attachment; filename=" + s_date + "至" + e_date + "门诊收入统计表（核算前）.xls");
                }
