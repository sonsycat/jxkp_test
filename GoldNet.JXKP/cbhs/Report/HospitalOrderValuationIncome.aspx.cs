...
{
    public partial class HospitalOrderValuationIncome : PageBase
    {
        ...
        private void Query()
        {
            ...
            DataTable table = report_dal.GetHospitalOrderValuationIncome(GetBeginDate(), GetEndDate(), balance, deptcode, depttype);
            if (table != null && table.Rows.Count > 0)
            {
                ...
                Session.Remove("HospitalOrderValuationIncome");
                Session["HospitalOrderValuationIncome"] = STable;
            }
            else
            {
        ...
        {
            if (Session["HospitalOrderValuationIncome"] != null)
            {
                ExportData ex = new ExportData();
                DataTable dt = (DataTable)Session["HospitalOrderValuationIncome"];
                ...
                ex.ExportToLocal(dt, this.Page, "xls", "住院开单科室计价收入统计表");
            }
        }
        /// <summary>
        /// 开始时间
