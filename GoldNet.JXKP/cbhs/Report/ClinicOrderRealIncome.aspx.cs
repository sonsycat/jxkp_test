...
{
    public partial class ClinicOrderRealIncome : PageBase
    {
        ...
        private void Query()
        {
            ...
            DataTable table = report_dal.GetClinicOrderRealIncome(GetBeginDate(), GetEndDate(), deptcode, depttype);
            if (table != null && table.Rows.Count > 0)
            {
                ...
                Session.Remove("ClinicOrderRealIncome");
                Session["ClinicOrderRealIncome"] = STable;
            }
            else
            {
        ...
        {
            if (Session["ClinicOrderRealIncome"] != null)
            {
                ExportData ex = new ExportData();
                DataTable dt = (DataTable)Session["ClinicOrderRealIncome"];
                ...
                ex.ExportToLocal(dt, this.Page, "xls", "门诊开单科室实际收入统计表");
            }
        }
        /// <summary>
        /// 开始时间
