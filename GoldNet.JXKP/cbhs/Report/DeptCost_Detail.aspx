<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptCost_Detail.aspx.cs"
    Inherits="GoldNet.JXKP.DeptCost_Detail" %>
                            ...
                            <ext:Panel runat="server" ID="p11" AutoScroll="true" Border="false">
                                    ...
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="ComboBox1" runat="server" ReadOnly="true" ForceSelection="true"
                                                SelectOnFocus="true" Width="70" SelectedIndex="0" >
                                                <Items>
                                ...
                                <Body>
                                    <table width="800">
                                        ...
                                        <tr>
                                            <td>
                                                <ext:ExtGridPanel ID="gpCost" runat="server" StoreID="SReportCost" Border="true"
                                                    Width="800" AutoScroll="true" StyleSpec="margin:10px">
                                                    <ExtColumnModel ID="ColumnModel1" runat="server">
                                                        <Columns>
                                                            <ext:ExtColumn ColumnID="ITEM_NAME" Header="<div style='text-align:center;'>成本科目名称</div>"
                                                                Width="180" DataIndex="ITEM_NAME" MenuDisabled="true">
                                                                <%-- <Renderer Fn="namecolor" />--%>
                                                            </ext:ExtColumn>
                                                            <ext:ExtColumn ColumnID="TOTALCOST" Header="<div style='text-align:center;'>成本合计</div>"
                                                                Width="120" DataIndex="TOTALCOST" MenuDisabled="true" Align="Right">
                                                                <Renderer Fn="rmbMoney" />
                                                            </ext:ExtColumn>
                                                            <ext:ExtColumn ColumnID="COSTS" Header="<div style='text-align:center;'>对外成本</div>"
                                                                Width="120" DataIndex="COSTS" MenuDisabled="true" Align="Right">
                                                                <Renderer Fn="rmbMoney" />
                                                            </ext:ExtColumn>
                                                            <ext:ExtColumn ColumnID="COSTS_ARMYFREE" Header="<div style='text-align:center;'>减免成本</div>"
                                                                Width="120" DataIndex="COSTS_ARMYFREE" MenuDisabled="true" Align="Right">
                                                                <Renderer Fn="rmbMoney" />
                                                            </ext:ExtColumn>
                                                        </Columns>
                                                        <HeadRows>
                                                            <ext:ExtRows>
                                                                <Rows>
                                                                    ...
                                                                    <ext:ExtRow Header="成本" ColSpan="3" Align="Center" />
                                                                </Rows>
                                                            </ext:ExtRows>
                                                        </HeadRows>
                                                    </ExtColumnModel>
                                                    ...
                                                    <AjaxEvents>
                                                        ...
                                                        <extraparams>
                                                            <ext:Parameter Name="Values" Value="Ext.encode(#{gpCost}.getRowsValues())" Mode="Raw" />
                                                        </extraparams>
                                                        </DblClick>
                                                    </AjaxEvents>
                                                    <Listeners>
                                                        <BeforeRender Handler="Ext.EventManager.onWindowResize(function(){ if(Ext.getBody().getViewSize().width>850){this.setWidth( Ext.getBody().getViewSize().width -18);}this.setHeight( Ext.getBody().getViewSize().height -150); }, this)" />
                                                        <Render Handler="if(Ext.getBody().getViewSize().width>850){this.setWidth( Ext.getBody().getViewSize().width -18);}this.setHeight( Ext.getBody().getViewSize().height -150);" />
                                                    </Listeners>
