<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SimpleIncomeDetail.aspx.cs"
    Inherits="GoldNet.JXKP.SimpleIncomeDetail" %>
...
<body>
    ...
    <div>
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbb_ReckItem" runat="server" AllowBlank="true" ForceSelection="true" SelectOnFocus="true" EmptyText="选择科室类别" Width="100">
                                               
                                            </ext:ComboBox>
                                            <ext:ComboBox ID="cbbType" runat="server"  ReadOnly="true" ForceSelection="true"
                                                SelectOnFocus="true" SelectedIndex="1">
                                                <Items>
     ...
     <ext:Window ID="Income_Detail" runat="server" Icon="Group" Title="收入项目" Width="900" Height="500"
