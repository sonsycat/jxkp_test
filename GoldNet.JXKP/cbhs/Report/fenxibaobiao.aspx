<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fenxibaobiao.aspx.cs" Inherits="GoldNet.JXKP.fenxibaobiao" %>
                            ...
                            <ext:GridPanel ID="GridPanel2" runat="server" Border="false" StoreID="Store1" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_detptype" runat="server" StyleSpec="border:0">
                                        <Items>
                                            <ext:Label ID="lcaption" runat="server" Text="当期时间：">
                                            </ext:Label>
                                            ...
                                            <ext:Label ID="lmonth" runat="server" Text="月 对比时间：">
                                            </ext:Label>
