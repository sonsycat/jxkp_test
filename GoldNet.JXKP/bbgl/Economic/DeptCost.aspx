<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptCost.aspx.cs" Inherits="GoldNet.JXKP.bbgl.Economic.DeptCost" %>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="<center>成本项目</center>" Sortable="true" ColumnID="Columns1" DataIndex="Columns1"
                                            Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>对外医疗支出</center>" Sortable="true" ColumnID="Columns2"
                                            DataIndex="Columns2" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>卫生事业支出</center>" Sortable="true" ColumnID="Columns3"
                                            DataIndex="Columns3" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>合计支出</center>" Sortable="true" ColumnID="Columns4" DataIndex="Columns4"
                                            Align="center" Width="116">
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
