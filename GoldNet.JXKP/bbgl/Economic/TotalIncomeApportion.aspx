<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TotalIncomeApportion.aspx.cs"
    Inherits="GoldNet.JXKP.bbgl.Economic.TotalIncomeApportion" %>
                        ...
                        <ext:LayoutColumn ColumnWidth="1">
                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        <ext:Column Header="<center>项目名称</center>" Sortable="true" ColumnID="Columns1" DataIndex="Columns1"
                                            Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>计价收入</center>" Sortable="true" ColumnID="Columns2" DataIndex="Columns2"
                                            Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>实际收入</center>" Sortable="true" ColumnID="Columns3" DataIndex="Columns3"
                                            Align="center" Width="116">
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
