<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClinicOutHospitalDiagnose.aspx.cs"
    Inherits="GoldNet.JXKP.bbgl.MedicalIndicators.ClinicOutHospitalDiagnose" %>
                            ...
                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="<center>门诊与出院诊断不符合</center>" Sortable="true" ColumnID="Columns2"
                                            DataIndex="Columns2" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>入院与出院诊断不符合</center>" Sortable="true" ColumnID="Columns3"
                                            DataIndex="Columns3" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>术前与术后诊断不符合</center>" Sortable="true" ColumnID="Columns4"
                                            DataIndex="Columns4" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>放射与术后诊断不符合</center>" Sortable="true" ColumnID="Columns5"
                                            DataIndex="Columns5" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>临床与病理诊断不符合</center>" Sortable="true" ColumnID="Columns6"
                                            DataIndex="Columns6" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>放射与病理诊断不符合</center>" Sortable="true" ColumnID="Columns7"
