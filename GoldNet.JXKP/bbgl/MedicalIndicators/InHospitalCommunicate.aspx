<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InHospitalCommunicate.aspx.cs"
    Inherits="GoldNet.JXKP.bbgl.MedicalIndicators.InHospitalCommunicate" %>
                            ...
                            <ext:GridPanel ID="GridPanel_Show" runat="server" StoreID="Store1" Border="false"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar_ZLJK" runat="server" Visible="true">
                                        <Items>
                                            ...
                                            <ext:Radio ID="radio1" Checked="true" runat="server" BoxLabel="院内感染" GroupName="inhos">
                                                <AjaxEvents>
                                            ...
                                            <ext:Radio ID="radio2" runat="server" BoxLabel="危重病人" GroupName="inhos"></ext:Radio>
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column Header="<center>无菌手术切口感染人数</center>" Sortable="true" ColumnID="Columns3"
                                            DataIndex="Columns3" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>手术并发症发生数</center>" Sortable="true" ColumnID="Columns4"
                                            DataIndex="Columns4" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>非手术并发症发生数</center>" Sortable="true" ColumnID="Columns5"
                                            DataIndex="Columns5" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>住院病人门诊诊断待诊人数</center>" Sortable="true" ColumnID="Columns6"
                                            DataIndex="Columns6" Align="center" Width="116">
                                        </ext:Column>
                                        <ext:Column Header="<center>住院病人初诊待诊人数</center>" Sortable="true" ColumnID="Columns7"
